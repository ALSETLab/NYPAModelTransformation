...
// -- Non Conform Loads:
// -- Generator Units:
CimSystem.Generators.GEN1_1_25d4 gen1_1_25d4(V_b = BUS1_24aa.V_b, v_0 = pf.powerflow.bus.VBUS1_24aa, angle_0 = pf.powerflow.bus.ABUS1_24aa, P_0 = pf.powerflow.loads.PGEN1_1_25d4, Q_0 = pf.powerflow.loads.QGEN1_1_25d4);
CimSystem.Generators.GEN2_1_25dc gen2_1_25dc(V_b = BUS2_24c6.V_b, v_0 = pf.powerflow.bus.VBUS2_24c6, angle_0 = pf.powerflow.bus.ABUS2_24c6, P_0 = pf.powerflow.loads.PGEN2_1_25dc, Q_0 = pf.powerflow.loads.QGEN2_1_25dc);
CimSystem.Generators.GEN3_1_25e5 gen3_1_25e5(V_b = BUS3_24d4.V_b, v_0 = pf.powerflow.bus.VBUS3_24d4, angle_0 = pf.powerflow.bus.ABUS3_24d4, P_0 = pf.powerflow.loads.PGEN3_1_25e5, Q_0 = pf.powerflow.loads.QGEN3_1_25e5);
CimSystem.Generators.GEN6_1_25ed gen6_1_25ed(V_b = BUS6_24fe.V_b, v_0 = pf.powerflow.bus.VBUS6_24fe, angle_0 = pf.powerflow.bus.ABUS6_24fe, P_0 = pf.powerflow.loads.PGEN6_1_25ed, Q_0 = pf.powerflow.loads.QGEN6_1_25ed);
CimSystem.Generators.GEN8_1_25f5 gen8_1_25f5(V_b = BUS8_2520.V_b, v_0 = pf.powerflow.bus.VBUS8_2520, angle_0 = pf.powerflow.bus.ABUS8_2520, P_0 = pf.powerflow.loads.PGEN8_1_25f5, Q_0 = pf.powerflow.loads.QGEN8_1_25f5);
equation
...
model GEN1_1_25d4
	...
	OpenIPSL.Electrical.Controls.PSSE.PSS.PSS2A pss(M = 5,N = 1,T_w1 = 2.00000,T_w2 = 2.00000,T_6= 0.00000,T_w3 = 2.00000,T_w4 = 0.00000,T_7 = 2.00000,K_S2 = 0.20000,K_S3 = 1.00000,T_8 = 0.50000,T_9 = 0.10000,K_S1 = 10.00000,T_1 = 0.15000,T_2 = 0.03000,T_3 = 0.15000,T_4 = 0.03000,V_STMAX = 0.10000,V_STMIN = -0.10000) annotation(Placement(transformation(extent = {{-70, -10}, {-50, 10}})));
equation
...
record PF_Trafos_00000
  extends CimSystem.PF_Data.Trafos_Data.Trafos_Template(T470_1_T1=68.777,T470_1_T2=138.0,T490_1_T1=68.777,T490_1_T2=138.0,T650_1_T1=137.55,T650_1_T2=69.0,T870_1_T1=68.777,T870_1_T2=138.0);
end PF_Trafos_00000;
