...
import sys,os
sys.path.append('C:\\Program Files (x86)\\PTI\\PSSE33\\PSSBIN') #make this point to the pssbin directory
...
for item in simulationtype:
        ...
        for test in models_tested:
                ...
                # Setting time step equal to 5ms:
                ...
                # Setting time step equal to 1ms during the fault:
