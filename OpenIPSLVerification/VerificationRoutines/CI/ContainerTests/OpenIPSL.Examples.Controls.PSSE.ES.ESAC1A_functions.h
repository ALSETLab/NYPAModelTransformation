...
void OpenIPSL_Types_ComplexPower_1_2_construct_p(threadData_t *threadData, void* v_ths , modelica_real in_re, modelica_real in_im);
#define OpenIPSL_Types_ComplexPower_1_2_construct(td, ths , in_re, in_im) OpenIPSL_Types_ComplexPower_1_2_construct_p(td, &ths , in_re, in_im)

#define alloc_OpenIPSL_Types_ComplexPower_1_2_array(dst,ndims,...) generic_array_create(NULL, dst, OpenIPSL_Types_ComplexPower_1_2_construct_p, ndims, sizeof(OpenIPSL_Types_ComplexPower), __VA_ARGS__)
...
DLLExport
OpenIPSL_Types_ComplexPower omc_OpenIPSL_Types_ComplexPower (threadData_t *threadData, modelica_real omc_re, modelica_real omc_im);

DLLExport
modelica_metatype boxptr_OpenIPSL_Types_ComplexPower(threadData_t *threadData, modelica_metatype _re, modelica_metatype _im);
static const MMC_DEFSTRUCTLIT(boxvar_lit_OpenIPSL_Types_ComplexPower,2,0) {(void*) boxptr_OpenIPSL_Types_ComplexPower,0}};
#define boxvar_OpenIPSL_Types_ComplexPower MMC_REFSTRUCTLIT(boxvar_lit_OpenIPSL_Types_ComplexPower)
