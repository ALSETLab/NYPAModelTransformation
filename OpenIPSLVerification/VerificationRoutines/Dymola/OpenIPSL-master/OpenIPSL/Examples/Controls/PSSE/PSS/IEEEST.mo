...
model IEEEST "SMIB system with one load and GENROE model"
  ...
  OpenIPSL.Electrical.Controls.PSSE.PSS.IEEEST iEEEST(
    ...
    V_CU=0.0,
    V_CL=0.0)
    annotation (Placement(transformation(extent={{-96,-42},{-68,-30}})));
equation
  ...
  connect(eSST1A.XADIFD, gENROE.XADIFD) annotation (Line(points={{-95.7,
          -89.6667},{-50,-89.6667},{-50,-18},{-60.4,-18}},
                                                 color={0,0,127}));
  connect(iEEEST.V_CT, gENROE.ETERM) annotation (Line(points={{-95.7667,-33},{
          -102,-33},{-102,-28},{-54,-28},{-54,-6},{-60,-6}},
                                                        color={0,0,127}));
  connect(iEEEST.V_S, gENROE.PELEC) annotation (Line(points={{-95.7667,-39},{
          -102,-39},{-102,-52},{-56,-52},{-56,6},{-60,6}},
                                                      color={0,0,127}));
  connect(eSST1A.VOTHSG2, const.y) annotation (Line(points={{-58,-62.5},{-46,-62.5},
          {-46,-76},{-43,-76}}, color={0,0,127}));
  connect(iEEEST.VOTHSG, eSST1A.VOTHSG) annotation (Line(points={{-66.8333,-36},
          {-48,-36},{-48,-65.8333},{-58,-65.8333}}, color={0,0,127}));
