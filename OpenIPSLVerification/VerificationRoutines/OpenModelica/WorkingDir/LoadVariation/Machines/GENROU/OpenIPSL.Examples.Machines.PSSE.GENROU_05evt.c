...
void OpenIPSL_Examples_Machines_PSSE_GENROU_function_initSample(DATA *data, threadData_t *threadData)
{
  long i=0;
}

const char *OpenIPSL_Examples_Machines_PSSE_GENROU_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
...
int OpenIPSL_Examples_Machines_PSSE_GENROU_function_ZeroCrossingsEquations(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int OpenIPSL_Examples_Machines_PSSE_GENROU_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  TRACE_PUSH
...
const char *OpenIPSL_Examples_Machines_PSSE_GENROU_relationDescription(int i)
{
...
int OpenIPSL_Examples_Machines_PSSE_GENROU_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  TRACE_PUSH
