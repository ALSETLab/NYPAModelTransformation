...
extern "C" {
#endif
const char *OpenIPSL_Examples_Machines_PSSE_GENROU_linear_model_frame()
{
  return "model linear_OpenIPSL_Examples_Machines_PSSE_GENROU\n  parameter Integer n = 8 \"number of states\";\n  parameter Integer m = 0 \"number of inputs\";\n  parameter Integer p = 0 \"number of outputs\";\n"
  "\n"
  ...
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\nend linear_OpenIPSL_Examples_Machines_PSSE_GENROU;\n";
}
const char *OpenIPSL_Examples_Machines_PSSE_GENROU_linear_model_datarecovery_frame()
{
