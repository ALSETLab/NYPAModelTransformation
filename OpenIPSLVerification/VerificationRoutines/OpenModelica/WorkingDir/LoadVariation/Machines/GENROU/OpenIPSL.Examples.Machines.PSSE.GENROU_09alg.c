...
extern void OpenIPSL_Examples_Machines_PSSE_GENROU_eqFunction_221(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Machines_PSSE_GENROU_eqFunction_222(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Machines_PSSE_GENROU_eqFunction_238(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Machines_PSSE_GENROU_eqFunction_249(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Machines_PSSE_GENROU_eqFunction_257(DATA* data, threadData_t *threadData);
...
int OpenIPSL_Examples_Machines_PSSE_GENROU_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  OpenIPSL_Examples_Machines_PSSE_GENROU_function_savePreSynchronous(data, threadData);
