...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1173(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = DIVISION((data->localData[0]->realVars[183] /* pwLine1.vs.re variable */) * (jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) + (data->localData[0]->realVars[182] /* pwLine1.vs.im variable */) * (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */),sqrt((tmp0 * tmp0) + (tmp1 * tmp1)),"sqrt(pwLine1.vs.re ^ 2.0 + pwLine1.vs.im ^ 2.0)");
  TRACE_POP
}
...
equation index: 1174
type: SIMPLE_ASSIGN
constantLoad.kI.$pDERNLSJac26.dummyVarNLSJac26 = if constantLoad.v < 0.5 then constantLoad.a2 * constantLoad.b2 * (constantLoad.v ^ (-1.0 + constantLoad.b2) * (-exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) * constantLoad.a2 * (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (constantLoad.b2 - 1.0) * constantLoad.b2 * constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26) + (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (-1.0 + constantLoad.b2 - 1.0) * (-1.0 + constantLoad.b2) * constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26) * exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) else 0.0
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1174(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp44)
  {
    ...
    else
    {
      ...
      tmp26 = (tmp20) * ((data->simulationInfo->realParameter[68] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */));
    }
    ...
    else
    {
      ...
      tmp36 = (tmp30) * ((-1.0 + data->simulationInfo->realParameter[68] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */));
    }
  ...
  jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = tmp45;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1176(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* constantLoad.Q.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((tmp47 && tmp48)?(data->simulationInfo->realParameter[44] /* constantLoad.S_I.im PARAM */) * ((data->localData[0]->realVars[69] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[48] /* constantLoad.S_Y.im PARAM */) * (((2.0) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[2] /* constantLoad.kP.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[46] /* constantLoad.S_P.im PARAM */ + data->simulationInfo->realParameter[70] /* constantLoad.d_Q PARAM */):(data->simulationInfo->realParameter[44] /* constantLoad.S_I.im PARAM */) * ((data->localData[0]->realVars[69] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[48] /* constantLoad.S_Y.im PARAM */) * (((2.0) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[2] /* constantLoad.kP.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[46] /* constantLoad.S_P.im PARAM */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1177(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* constantLoad.P.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((tmp49 && tmp50)?(data->simulationInfo->realParameter[45] /* constantLoad.S_I.re PARAM */) * ((data->localData[0]->realVars[69] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[49] /* constantLoad.S_Y.re PARAM */) * (((2.0) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[2] /* constantLoad.kP.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[47] /* constantLoad.S_P.re PARAM */ + data->simulationInfo->realParameter[69] /* constantLoad.d_P PARAM */):(data->simulationInfo->realParameter[45] /* constantLoad.S_I.re PARAM */) * ((data->localData[0]->realVars[69] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[49] /* constantLoad.S_Y.re PARAM */) * (((2.0) * (data->localData[0]->realVars[73] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[2] /* constantLoad.kP.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[47] /* constantLoad.S_P.re PARAM */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1178(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* gENROE.PSId.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[275] /* gENROE.Xppd PARAM */)) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac26 SEED_VAR */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1179(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[48] /* $cse6 variable */) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac26 SEED_VAR */) - ((data->localData[0]->realVars[49] /* $cse7 variable */) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac26 SEED_VAR */))) * (data->simulationInfo->realParameter[221] /* gENROE.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1180(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[7] /* pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[49] /* $cse7 variable */) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac26 SEED_VAR */) + (data->localData[0]->realVars[48] /* $cse6 variable */) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[221] /* gENROE.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1181(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = jacobian->tmpVars[5] /* gENROE.PSId.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[258] /* gENROE.R_a PARAM */) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac26 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1182(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[9] /* gENROE.PSIq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[276] /* gENROE.Xppq PARAM */)) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac26 SEED_VAR */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1183(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[9] /* gENROE.PSIq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) - ((data->simulationInfo->realParameter[258] /* gENROE.R_a PARAM */) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac26 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1184(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[48] /* $cse6 variable */) * (jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) - ((data->localData[0]->realVars[49] /* $cse7 variable */) * (jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1185(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (data->localData[0]->realVars[48] /* $cse6 variable */) * (jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (data->localData[0]->realVars[49] /* $cse7 variable */) * (jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1186(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[13] /* gENCLS.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[45] /* $cse2 variable */) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac26 SEED_VAR */) - ((data->localData[0]->realVars[44] /* $cse1 variable */) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac26 SEED_VAR */))) * (data->simulationInfo->realParameter[195] /* gENCLS.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1187(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[14] /* gENCLS.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (((-data->localData[0]->realVars[44] /* $cse1 variable */)) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac26 SEED_VAR */) - ((data->localData[0]->realVars[45] /* $cse2 variable */) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac26 SEED_VAR */))) * (data->simulationInfo->realParameter[195] /* gENCLS.CoB PARAM */);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1188(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[201] /* gENCLS.R_a PARAM */)) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac26 SEED_VAR */) - ((data->simulationInfo->realParameter[204] /* gENCLS.X_d PARAM */) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac26 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1189(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[204] /* gENCLS.X_d PARAM */) * (jacobian->seedVars[12] /* gENCLS.iq.SeedNLSJac26 SEED_VAR */) - ((data->simulationInfo->realParameter[201] /* gENCLS.R_a PARAM */) * (jacobian->seedVars[13] /* gENCLS.id.SeedNLSJac26 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1190(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[17] /* pwLine1.ir.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[11] /* pwLine4.ir.im.SeedNLSJac26 SEED_VAR */) - jacobian->tmpVars[13] /* gENCLS.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1191(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[18] /* pwLine1.ir.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[10] /* pwLine4.ir.re.SeedNLSJac26 SEED_VAR */) - jacobian->tmpVars[14] /* gENCLS.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1192(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac26 SEED_VAR */) - jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac26 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1193(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac26 SEED_VAR */) - jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac26 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1194(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[21] /* constantLoad.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac26 SEED_VAR */) - jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[9] /* pwLine3.is.re.SeedNLSJac26 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1195(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[22] /* constantLoad.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[1] /* pwLine.ir.im.SeedNLSJac26 SEED_VAR */) - jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[8] /* pwLine3.is.im.SeedNLSJac26 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1196(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp51 && tmp52)?jacobian->tmpVars[18] /* pwLine1.ir.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */:jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[499] /* pwLine1.Z.re PARAM */) * (jacobian->tmpVars[18] /* pwLine1.ir.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[498] /* pwLine1.Z.im PARAM */) * (jacobian->tmpVars[17] /* pwLine1.ir.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 1197
type: SIMPLE_ASSIGN
$res2.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.ir.im.$pDERNLSJac26.dummyVarNLSJac26 else pwLine1.vr.im.SeedNLSJac26 - pwLine1.vs.im.SeedNLSJac26 - (pwLine1.Z.re * (pwLine1.ir.im.$pDERNLSJac26.dummyVarNLSJac26 + (-pwLine1.vr.re.SeedNLSJac26) * pwLine1.Y.im - pwLine1.vr.im.SeedNLSJac26 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.ir.re.$pDERNLSJac26.dummyVarNLSJac26 + pwLine1.vr.im.SeedNLSJac26 * pwLine1.Y.im - pwLine1.vr.re.SeedNLSJac26 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1197(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[1] /* $res2.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp53 && tmp54)?jacobian->tmpVars[17] /* pwLine1.ir.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */:jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[499] /* pwLine1.Z.re PARAM */) * (jacobian->tmpVars[17] /* pwLine1.ir.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */))) + (data->simulationInfo->realParameter[498] /* pwLine1.Z.im PARAM */) * (jacobian->tmpVars[18] /* pwLine1.ir.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 1198
type: SIMPLE_ASSIGN
$res3.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine3.t1 and time < pwLine3.t2 then pwLine3.is.im.SeedNLSJac26 else pwLine1.vs.im.SeedNLSJac26 - pwLine3.vr.im.SeedNLSJac26 - (pwLine3.Z.re * (pwLine3.is.im.SeedNLSJac26 + (-pwLine1.vs.re.SeedNLSJac26) * pwLine3.Y.im - pwLine1.vs.im.SeedNLSJac26 * pwLine3.Y.re) + pwLine3.Z.im * (pwLine3.is.re.SeedNLSJac26 + pwLine1.vs.im.SeedNLSJac26 * pwLine3.Y.im - pwLine1.vs.re.SeedNLSJac26 * pwLine3.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1198(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[2] /* $res3.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp55 && tmp56)?jacobian->seedVars[8] /* pwLine3.is.im.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[510] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[8] /* pwLine3.is.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[509] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[9] /* pwLine3.is.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */)))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1199(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp57 && tmp58)?jacobian->seedVars[9] /* pwLine3.is.re.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[510] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[9] /* pwLine3.is.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[509] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[8] /* pwLine3.is.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1200(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp71)
  {
    tmp72 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp69)
    {
      tmp70 = jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp67)
      {
        ...
        tmp68 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[476] /* pwFault.R PARAM */) * (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) - ((data->simulationInfo->realParameter[477] /* pwFault.X PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */))) * ((tmp62 * tmp62) + (tmp63 * tmp63)),(tmp66 * tmp66),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp68 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
      }
      tmp70 = tmp68;
    }
    tmp72 = tmp70;
  }
  jacobian->resultVars[4] /* $res5.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = tmp72;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1201(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[5] /* $res6.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp73 && tmp74)?jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[521] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[520] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1202(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[6] /* $res7.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp75 && tmp76)?jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[521] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[7] /* pwLine4.is.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[520] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[5] /* pwLine4.is.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 1203
type: SIMPLE_ASSIGN
$res8.$pDERNLSJac26.dummyVarNLSJac26 = if time < pwFault.t1 then pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26 else if time < pwFault.t2 and pwFault.ground then pwLine3.vr.im.SeedNLSJac26 else if time < pwFault.t2 then pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26 - (pwFault.R * pwLine3.vr.re.SeedNLSJac26 + pwFault.X * pwLine3.vr.im.SeedNLSJac26) * (pwFault.R ^ 2.0 + pwFault.X ^ 2.0) / (pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0 else pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1203(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp89)
  {
    tmp90 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp87)
    {
      tmp88 = jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp85)
      {
        ...
        tmp86 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[476] /* pwFault.R PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */) + (data->simulationInfo->realParameter[477] /* pwFault.X PARAM */) * (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */)) * ((tmp80 * tmp80) + (tmp81 * tmp81)),(tmp84 * tmp84),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp86 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
      }
      tmp88 = tmp86;
    }
    tmp90 = tmp88;
  }
  jacobian->resultVars[7] /* $res8.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = tmp90;
  TRACE_POP
}
...
equation index: 1204
type: SIMPLE_ASSIGN
$res9.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine3.t1 and time < pwLine3.t2 then pwLine3.ir.im.SeedNLSJac26 else pwLine3.vr.im.SeedNLSJac26 - pwLine1.vs.im.SeedNLSJac26 - (pwLine3.Z.re * (pwLine3.ir.im.SeedNLSJac26 + (-pwLine3.vr.re.SeedNLSJac26) * pwLine3.Y.im - pwLine3.vr.im.SeedNLSJac26 * pwLine3.Y.re) + pwLine3.Z.im * (pwLine3.ir.re.SeedNLSJac26 + pwLine3.vr.im.SeedNLSJac26 * pwLine3.Y.im - pwLine3.vr.re.SeedNLSJac26 * pwLine3.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1204(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[8] /* $res9.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp91 && tmp92)?jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[510] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[509] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */)))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1205(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[9] /* $res10.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp93 && tmp94)?jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[510] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[4] /* pwLine3.ir.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[509] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[6] /* pwLine3.ir.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[507] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[508] /* pwLine3.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 1206
type: SIMPLE_ASSIGN
$res11.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 else pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 - pwLine1.vs.re.SeedNLSJac26 - (pwLine.Z.re * (pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 + pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 * pwLine.Y.re) - pwLine.Z.im * (pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 + (-pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1206(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[10] /* $res11.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp95 && tmp96)?jacobian->tmpVars[7] /* pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[488] /* pwLine.Z.re PARAM */) * (jacobian->tmpVars[7] /* pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + (jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[487] /* pwLine.Z.im PARAM */) * (jacobian->tmpVars[6] /* pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + ((-jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */)) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 1207
type: SIMPLE_ASSIGN
$res12.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 else pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 - pwLine1.vs.im.SeedNLSJac26 - (pwLine.Z.re * (pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 + (-pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 * pwLine.Y.re) + pwLine.Z.im * (pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 + pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1207(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[11] /* $res12.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp97 && tmp98)?jacobian->tmpVars[6] /* pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[488] /* pwLine.Z.re PARAM */) * (jacobian->tmpVars[6] /* pwLine.is.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + ((-jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */)) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */))) + (data->simulationInfo->realParameter[487] /* pwLine.Z.im PARAM */) * (jacobian->tmpVars[7] /* pwLine.is.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ + (jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 1208
type: SIMPLE_ASSIGN
$res13.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.im.SeedNLSJac26 else pwLine1.vs.im.SeedNLSJac26 - pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 - (pwLine.Z.re * (pwLine.ir.im.SeedNLSJac26 + (-pwLine1.vs.re.SeedNLSJac26) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac26 * pwLine.Y.re) + pwLine.Z.im * (pwLine.ir.re.SeedNLSJac26 + pwLine1.vs.im.SeedNLSJac26 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac26 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1208(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[12] /* $res13.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp99 && tmp100)?jacobian->seedVars[1] /* pwLine.ir.im.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */ - jacobian->tmpVars[11] /* pwLine.vs.im.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[488] /* pwLine.Z.re PARAM */) * (jacobian->seedVars[1] /* pwLine.ir.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */))) + (data->simulationInfo->realParameter[487] /* pwLine.Z.im PARAM */) * (jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 1209
type: SIMPLE_ASSIGN
$res14.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.re.SeedNLSJac26 else pwLine1.vs.re.SeedNLSJac26 - pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 - (pwLine.Z.re * (pwLine.ir.re.SeedNLSJac26 + pwLine1.vs.im.SeedNLSJac26 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac26 * pwLine.Y.re) - pwLine.Z.im * (pwLine.ir.im.SeedNLSJac26 + (-pwLine1.vs.re.SeedNLSJac26) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac26 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1209(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[13] /* $res14.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp101 && tmp102)?jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */ - jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[488] /* pwLine.Z.re PARAM */) * (jacobian->seedVars[3] /* pwLine.ir.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[487] /* pwLine.Z.im PARAM */) * (jacobian->seedVars[1] /* pwLine.ir.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[485] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[486] /* pwLine.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 1210
type: SIMPLE_ASSIGN
$res15.$pDERNLSJac26.dummyVarNLSJac26 = pwLine1.vs.im * constantLoad.p.ir.$pDERNLSJac26.dummyVarNLSJac26 + pwLine1.vs.im.SeedNLSJac26 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac26) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac26.dummyVarNLSJac26 - pwLine1.vs.re * constantLoad.p.ii.$pDERNLSJac26.dummyVarNLSJac26
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1210(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[14] /* $res15.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = (data->localData[0]->realVars[182] /* pwLine1.vs.im variable */) * (jacobian->tmpVars[21] /* constantLoad.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->localData[0]->realVars[72] /* constantLoad.p.ir variable */) + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->localData[0]->realVars[71] /* constantLoad.p.ii variable */) - jacobian->tmpVars[3] /* constantLoad.Q.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */ - ((data->localData[0]->realVars[183] /* pwLine1.vs.re variable */) * (jacobian->tmpVars[22] /* constantLoad.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */));
  TRACE_POP
}
...
equation index: 1211
type: SIMPLE_ASSIGN
$res16.$pDERNLSJac26.dummyVarNLSJac26 = pwLine1.vs.im * constantLoad.p.ii.$pDERNLSJac26.dummyVarNLSJac26 + pwLine1.vs.im.SeedNLSJac26 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.$pDERNLSJac26.dummyVarNLSJac26 + pwLine1.vs.re.SeedNLSJac26 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac26.dummyVarNLSJac26
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1211(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[15] /* $res16.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = (data->localData[0]->realVars[182] /* pwLine1.vs.im variable */) * (jacobian->tmpVars[22] /* constantLoad.p.ii.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->localData[0]->realVars[71] /* constantLoad.p.ii variable */) + (data->localData[0]->realVars[183] /* pwLine1.vs.re variable */) * (jacobian->tmpVars[21] /* constantLoad.p.ir.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->localData[0]->realVars[72] /* constantLoad.p.ir variable */) - jacobian->tmpVars[4] /* constantLoad.P.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1212(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[16] /* $res17.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp103 && tmp104)?jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[499] /* pwLine1.Z.re PARAM */) * (jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[498] /* pwLine1.Z.im PARAM */) * (jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 1213
type: SIMPLE_ASSIGN
$res18.$pDERNLSJac26.dummyVarNLSJac26 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.is.im.SeedNLSJac26 else pwLine1.vs.im.SeedNLSJac26 - pwLine1.vr.im.SeedNLSJac26 - (pwLine1.Z.re * (pwLine1.is.im.SeedNLSJac26 + (-pwLine1.vs.re.SeedNLSJac26) * pwLine1.Y.im - pwLine1.vs.im.SeedNLSJac26 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.is.re.SeedNLSJac26 + pwLine1.vs.im.SeedNLSJac26 * pwLine1.Y.im - pwLine1.vs.re.SeedNLSJac26 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1213(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[17] /* $res18.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp105 && tmp106)?jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[499] /* pwLine1.Z.re PARAM */) * (jacobian->seedVars[0] /* pwLine1.is.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */))) + (data->simulationInfo->realParameter[498] /* pwLine1.Z.im PARAM */) * (jacobian->seedVars[2] /* pwLine1.is.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[21] /* pwLine1.vs.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[496] /* pwLine1.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[497] /* pwLine1.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 1214
type: SIMPLE_ASSIGN
$res19.$pDERNLSJac26.dummyVarNLSJac26 = $cse1 * gENCLS.vq.$pDERNLSJac26.dummyVarNLSJac26 + (-$cse2) * gENCLS.vd.$pDERNLSJac26.dummyVarNLSJac26 - pwLine1.vr.im.SeedNLSJac26
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1214(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[18] /* $res19.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = (data->localData[0]->realVars[44] /* $cse1 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + ((-data->localData[0]->realVars[45] /* $cse2 variable */)) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1215(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[19] /* $res20.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp107 && tmp108)?jacobian->seedVars[10] /* pwLine4.ir.re.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[20] /* pwLine3.vr.re.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[521] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[10] /* pwLine4.ir.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[520] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[11] /* pwLine4.ir.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1216(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[20] /* $res21.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = ((tmp109 && tmp110)?jacobian->seedVars[11] /* pwLine4.ir.im.SeedNLSJac26 SEED_VAR */:jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */ - jacobian->seedVars[19] /* pwLine3.vr.im.SeedNLSJac26 SEED_VAR */ - ((data->simulationInfo->realParameter[521] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[11] /* pwLine4.ir.im.SeedNLSJac26 SEED_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */)) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[520] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[10] /* pwLine4.ir.re.SeedNLSJac26 SEED_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[518] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */) * (data->simulationInfo->realParameter[519] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 1217
type: SIMPLE_ASSIGN
$res22.$pDERNLSJac26.dummyVarNLSJac26 = $cse2 * gENCLS.vq.$pDERNLSJac26.dummyVarNLSJac26 + $cse1 * gENCLS.vd.$pDERNLSJac26.dummyVarNLSJac26 - pwLine1.vr.re.SeedNLSJac26
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1217(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[21] /* $res22.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_VAR */ = (data->localData[0]->realVars[45] /* $cse2 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) + (data->localData[0]->realVars[44] /* $cse1 variable */) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac26.dummyVarNLSJac26 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac26 SEED_VAR */;
  TRACE_POP
}

OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_functionJacNLSJac26_constantEqns(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH

  DATA* data = ((DATA*)inData);
  int index = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_INDEX_JAC_NLSJac26;
...
int OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_functionJacNLSJac26_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH
...
equation index: 1288
type: SIMPLE_ASSIGN
eSST1A.hV_GATE.n1.$pDERNLSJac27.dummyVarNLSJac27 = if eSST1A.add3_1.y > eSST1A.imLimited.uMax then 0.0 else if eSST1A.add3_1.y < eSST1A.imLimited.uMin then 0.0 else eSST1A.add3_1.y.SeedNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1288(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp114 = (tmp112?0.0:jacobian->seedVars[0] /* eSST1A.add3_1.y.SeedNLSJac27 SEED_VAR */);
  }
  jacobian->tmpVars[0] /* eSST1A.hV_GATE.n1.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = tmp114;
  TRACE_POP
}
...
equation index: 1289
type: SIMPLE_ASSIGN
eSST1A.hV_GATE.p.$pDERNLSJac27.dummyVarNLSJac27 = if eSST1A.hV_GATE.n1 < const1.k then 0.0 else eSST1A.hV_GATE.n1.$pDERNLSJac27.dummyVarNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1289(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[1] /* eSST1A.hV_GATE.p.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = (tmp115?0.0:jacobian->tmpVars[0] /* eSST1A.hV_GATE.n1.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 1290
type: SIMPLE_ASSIGN
eSST1A.imDerivativeLag.y.$pDERNLSJac27.dummyVarNLSJac27 = eSST1A.add3_1.y.SeedNLSJac27 / eSST1A.add3_1.k1
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1290(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[2] /* eSST1A.imDerivativeLag.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = DIVISION(jacobian->seedVars[0] /* eSST1A.add3_1.y.SeedNLSJac27 SEED_VAR */,data->simulationInfo->realParameter[131] /* eSST1A.add3_1.k1 PARAM */,"eSST1A.add3_1.k1");
  TRACE_POP
}
...
equation index: 1291
type: SIMPLE_ASSIGN
eSST1A.imLeadLag.TF.y.$pDERNLSJac27.dummyVarNLSJac27 = eSST1A.imLeadLag.TF.d * eSST1A.hV_GATE.p.$pDERNLSJac27.dummyVarNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1291(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* eSST1A.imLeadLag.TF.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[158] /* eSST1A.imLeadLag.TF.d PARAM */) * (jacobian->tmpVars[1] /* eSST1A.hV_GATE.p.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 1292
type: SIMPLE_ASSIGN
eSST1A.imLeadLag.y.$pDERNLSJac27.dummyVarNLSJac27 = if abs(eSST1A.imLeadLag.T1 - eSST1A.imLeadLag.T2) < 1e-15 then eSST1A.imLeadLag.K * eSST1A.hV_GATE.p.$pDERNLSJac27.dummyVarNLSJac27 else eSST1A.imLeadLag.TF.y.$pDERNLSJac27.dummyVarNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1292(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* eSST1A.imLeadLag.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = (tmp116?(data->simulationInfo->realParameter[147] /* eSST1A.imLeadLag.K PARAM */) * (jacobian->tmpVars[1] /* eSST1A.hV_GATE.p.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */):jacobian->tmpVars[3] /* eSST1A.imLeadLag.TF.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 1293
type: SIMPLE_ASSIGN
eSST1A.imLeadLag1.TF.y.$pDERNLSJac27.dummyVarNLSJac27 = eSST1A.imLeadLag1.TF.d * eSST1A.imLeadLag.y.$pDERNLSJac27.dummyVarNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1293(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* eSST1A.imLeadLag1.TF.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[176] /* eSST1A.imLeadLag1.TF.d PARAM */) * (jacobian->tmpVars[4] /* eSST1A.imLeadLag.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 1294
type: SIMPLE_ASSIGN
eSST1A.imLeadLag1.y.$pDERNLSJac27.dummyVarNLSJac27 = if abs(eSST1A.imLeadLag1.T1 - eSST1A.imLeadLag1.T2) < 1e-15 then eSST1A.imLeadLag1.K * eSST1A.imLeadLag.y.$pDERNLSJac27.dummyVarNLSJac27 else eSST1A.imLeadLag1.TF.y.$pDERNLSJac27.dummyVarNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1294(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[6] /* eSST1A.imLeadLag1.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = (tmp117?(data->simulationInfo->realParameter[165] /* eSST1A.imLeadLag1.K PARAM */) * (jacobian->tmpVars[4] /* eSST1A.imLeadLag.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */):jacobian->tmpVars[5] /* eSST1A.imLeadLag1.TF.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 1295
type: SIMPLE_ASSIGN
eSST1A.add3_2.u2.$pDERNLSJac27.dummyVarNLSJac27 = if abs(eSST1A.simpleLagLim.T) <= 1e-15 then if noEvent(min(eSST1A.imLeadLag1.y * eSST1A.simpleLagLim.K, eSST1A.simpleLagLim.outMax) > eSST1A.simpleLagLim.outMin) then if noEvent(eSST1A.imLeadLag1.y * eSST1A.simpleLagLim.K < eSST1A.simpleLagLim.outMax) then eSST1A.imLeadLag1.y.$pDERNLSJac27.dummyVarNLSJac27 * eSST1A.simpleLagLim.K else 0.0 else 0.0 else 0.0
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1295(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp123)
  {
    ...
    if(tmp121)
    {
      ...
      tmp122 = (tmp120?(jacobian->tmpVars[6] /* eSST1A.imLeadLag1.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[188] /* eSST1A.simpleLagLim.K PARAM */):0.0);
    }
    else
    {
      tmp122 = 0.0;
  ...
  jacobian->tmpVars[7] /* eSST1A.add3_2.u2.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = tmp124;
  TRACE_POP
}
...
equation index: 1296
type: SIMPLE_ASSIGN
eSST1A.add3_2.y.$pDERNLSJac27.dummyVarNLSJac27 = eSST1A.add3_2.k2 * eSST1A.add3_2.u2.$pDERNLSJac27.dummyVarNLSJac27
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1296(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[8] /* eSST1A.add3_2.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[135] /* eSST1A.add3_2.k2 PARAM */) * (jacobian->tmpVars[7] /* eSST1A.add3_2.u2.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */);
  TRACE_POP
}
...
equation index: 1297
type: SIMPLE_ASSIGN
$res1.$pDERNLSJac27.dummyVarNLSJac27 = eSST1A.add3_2.y.$pDERNLSJac27.dummyVarNLSJac27 - eSST1A.imDerivativeLag.y.$pDERNLSJac27.dummyVarNLSJac27 * eSST1A.imDerivativeLag.T
*/
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_eqFunction_1297(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_VAR */ = jacobian->tmpVars[8] /* eSST1A.add3_2.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */ - ((jacobian->tmpVars[2] /* eSST1A.imDerivativeLag.y.$pDERNLSJac27.dummyVarNLSJac27 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[139] /* eSST1A.imDerivativeLag.T PARAM */));
  TRACE_POP
}

OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_functionJacNLSJac27_constantEqns(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH

  DATA* data = ((DATA*)inData);
  int index = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_INDEX_JAC_NLSJac27;
...
int OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_functionJacNLSJac27_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH
...
OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_initialAnalyticJacobianNLSJac26(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian)
{
  TRACE_PUSH
  DATA* data = ((DATA*)inData);
...
OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_initialAnalyticJacobianNLSJac27(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian)
{
  TRACE_PUSH
  DATA* data = ((DATA*)inData);
