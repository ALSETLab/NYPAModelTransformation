...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2A_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[9].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2A_functionJacNLSJac23_column;
  nonLinearSystemData[9].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2A_initialAnalyticJacobianNLSJac23;
  ...
  nonLinearSystemData[8].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2A_functionJacNLSJac22_column;
  nonLinearSystemData[8].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2A_initialAnalyticJacobianNLSJac22;
