...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_121(DATA *data, threadData_t *threadData)
{
  ...
  modelica_boolean tmp0;
  RELATIONHYSTERESIS(tmp0, data->localData[0]->realVars[43] /* constantLoad.v variable */, data->simulationInfo->realParameter[35] /* constantLoad.PQBRAK PARAM */, 7, Less);
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_124(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[60] /* gENSAL.PSId variable */ = data->localData[0]->realVars[61] /* gENSAL.PSIppd variable */ - ((data->simulationInfo->realParameter[151] /* gENSAL.Xppd PARAM */) * (data->localData[0]->realVars[67] /* gENSAL.id variable */));
  TRACE_POP
}
/*
equation index: 125
type: SIMPLE_ASSIGN
pwLine.is.re = ($cse7 * gENSAL.iq - (-$cse6) * gENSAL.id) * gENSAL.CoB
*/
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_125(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,125};
  data->localData[0]->realVars[80] /* pwLine.is.re variable */ = ((data->localData[0]->realVars[19] /* $cse7 variable */) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */) - (((-data->localData[0]->realVars[18] /* $cse6 variable */)) * (data->localData[0]->realVars[67] /* gENSAL.id variable */))) * (data->simulationInfo->realParameter[102] /* gENSAL.CoB PARAM */);
  TRACE_POP
}
/*
equation index: 126
type: SIMPLE_ASSIGN
pwLine.is.im = ($cse6 * gENSAL.iq - $cse7 * gENSAL.id) * gENSAL.CoB
*/
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_126(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,126};
  data->localData[0]->realVars[79] /* pwLine.is.im variable */ = ((data->localData[0]->realVars[18] /* $cse6 variable */) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */) - ((data->localData[0]->realVars[19] /* $cse7 variable */) * (data->localData[0]->realVars[67] /* gENSAL.id variable */))) * (data->simulationInfo->realParameter[102] /* gENSAL.CoB PARAM */);
  TRACE_POP
}
/*
equation index: 127
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_127(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[70] /* gENSAL.uq variable */ = data->localData[0]->realVars[60] /* gENSAL.PSId variable */ - ((data->simulationInfo->realParameter[136] /* gENSAL.R_a PARAM */) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */));
  TRACE_POP
}
/*
equation index: 128
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_128(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[62] /* gENSAL.PSIq variable */ = (-data->localData[0]->realVars[4] /* gENSAL.PSIppq STATE(1) */) - ((data->simulationInfo->realParameter[152] /* gENSAL.Xppq PARAM */) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */));
  TRACE_POP
}
/*
equation index: 129
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_129(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[69] /* gENSAL.ud variable */ = (-data->localData[0]->realVars[62] /* gENSAL.PSIq variable */) - ((data->simulationInfo->realParameter[136] /* gENSAL.R_a PARAM */) * (data->localData[0]->realVars[67] /* gENSAL.id variable */));
  TRACE_POP
}
/*
equation index: 130
type: SIMPLE_ASSIGN
pwLine.vs.im = $cse6 * gENSAL.uq - $cse7 * gENSAL.ud
*/
...
equation index: 131
type: SIMPLE_ASSIGN
pwLine.vs.re = $cse6 * gENSAL.ud + $cse7 * gENSAL.uq
*/
...
void residualFunc209(void** dataIn, const double* xloc, double* res, const int* iflag)
{
  ...
  /* body */
  RELATIONHYSTERESIS(tmp0, data->localData[0]->timeValue, data->simulationInfo->realParameter[179] /* pwFault.t1 PARAM */, 10, Less);
  ...
  {
    RELATIONHYSTERESIS(tmp1, data->localData[0]->timeValue, data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */, 11, Less);
    ...
    {
      RELATIONHYSTERESIS(tmp2, data->localData[0]->timeValue, data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */, 11, Less);
      tmp5 = (modelica_boolean)tmp2;
      if(tmp5)
      {
        tmp3 = data->simulationInfo->realParameter[177] /* pwFault.R PARAM */;
        tmp4 = data->simulationInfo->realParameter[178] /* pwFault.X PARAM */;
        tmp6 = data->localData[0]->realVars[72] /* pwFault.p.ir variable */ - (DIVISION_SIM((data->simulationInfo->realParameter[177] /* pwFault.R PARAM */) * (data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) + (data->simulationInfo->realParameter[178] /* pwFault.X PARAM */) * (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */),(tmp3 * tmp3) + (tmp4 * tmp4),"pwFault.R ^ 2.0 + pwFault.X ^ 2.0",equationIndexes));
      }
      else
      {
  ...
  RELATIONHYSTERESIS(tmp11, data->localData[0]->timeValue, data->simulationInfo->realParameter[179] /* pwFault.t1 PARAM */, 10, Less);
  ...
  {
    RELATIONHYSTERESIS(tmp12, data->localData[0]->timeValue, data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */, 11, Less);
    ...
    {
      RELATIONHYSTERESIS(tmp13, data->localData[0]->timeValue, data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */, 11, Less);
      tmp16 = (modelica_boolean)tmp13;
      if(tmp16)
      {
        tmp14 = data->simulationInfo->realParameter[178] /* pwFault.X PARAM */;
        tmp15 = data->simulationInfo->realParameter[177] /* pwFault.R PARAM */;
        tmp17 = data->localData[0]->realVars[71] /* pwFault.p.ii variable */ - (DIVISION_SIM((data->simulationInfo->realParameter[177] /* pwFault.R PARAM */) * (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) - ((data->simulationInfo->realParameter[178] /* pwFault.X PARAM */) * (data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)),(tmp14 * tmp14) + (tmp15 * tmp15),"pwFault.X ^ 2.0 + pwFault.R ^ 2.0",equationIndexes));
      }
      else
      {
  ...
  RELATIONHYSTERESIS(tmp22, data->localData[0]->timeValue, data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */, 8, GreaterEq);
  RELATIONHYSTERESIS(tmp23, data->localData[0]->timeValue, data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */, 9, Less);
  res[2] = ((tmp22 && tmp23)?data->localData[0]->realVars[99] /* pwLine3.ir.im variable */:data->localData[0]->realVars[103] /* pwLine3.vr.im variable */ - data->localData[0]->realVars[93] /* pwLine1.vs.im variable */ - ((data->simulationInfo->realParameter[211] /* pwLine3.Z.re PARAM */) * (data->localData[0]->realVars[99] /* pwLine3.ir.im variable */ + ((-data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[210] /* pwLine3.Z.im PARAM */) * (data->localData[0]->realVars[100] /* pwLine3.ir.re variable */ + (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */)))));

  RELATIONHYSTERESIS(tmp24, data->localData[0]->timeValue, data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp25, data->localData[0]->timeValue, data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */, 3, Less);
  res[3] = ((tmp24 && tmp25)?data->localData[0]->realVars[90] /* pwLine1.is.re variable */:data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - ((data->simulationInfo->realParameter[200] /* pwLine1.Z.re PARAM */) * (data->localData[0]->realVars[90] /* pwLine1.is.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[199] /* pwLine1.Z.im PARAM */) * (data->localData[0]->realVars[89] /* pwLine1.is.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp26, data->localData[0]->timeValue, data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */, 12, GreaterEq);
  RELATIONHYSTERESIS(tmp27, data->localData[0]->timeValue, data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */, 13, Less);
  res[4] = ((tmp26 && tmp27)?data->localData[0]->realVars[109] /* pwLine4.ir.im variable */:data->localData[0]->realVars[91] /* pwLine1.vr.im variable */ - data->localData[0]->realVars[103] /* pwLine3.vr.im variable */ - ((data->simulationInfo->realParameter[222] /* pwLine4.Z.re PARAM */) * (data->localData[0]->realVars[109] /* pwLine4.ir.im variable */ + ((-data->localData[0]->realVars[92] /* pwLine1.vr.re variable */)) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[221] /* pwLine4.Z.im PARAM */) * (data->localData[0]->realVars[110] /* pwLine4.ir.re variable */ + (data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[92] /* pwLine1.vr.re variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */)))));
  ...
  RELATIONHYSTERESIS(tmp28, data->localData[0]->timeValue, data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */, 12, GreaterEq);
  RELATIONHYSTERESIS(tmp29, data->localData[0]->timeValue, data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */, 13, Less);
  res[6] = ((tmp28 && tmp29)?data->localData[0]->realVars[112] /* pwLine4.is.re variable */:data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - ((data->simulationInfo->realParameter[222] /* pwLine4.Z.re PARAM */) * (data->localData[0]->realVars[112] /* pwLine4.is.re variable */ + (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[221] /* pwLine4.Z.im PARAM */) * (data->localData[0]->realVars[111] /* pwLine4.is.im variable */ + ((-data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp30, data->localData[0]->timeValue, data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */, 12, GreaterEq);
  RELATIONHYSTERESIS(tmp31, data->localData[0]->timeValue, data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */, 13, Less);
  res[7] = ((tmp30 && tmp31)?data->localData[0]->realVars[111] /* pwLine4.is.im variable */:data->localData[0]->realVars[103] /* pwLine3.vr.im variable */ - data->localData[0]->realVars[91] /* pwLine1.vr.im variable */ - ((data->simulationInfo->realParameter[222] /* pwLine4.Z.re PARAM */) * (data->localData[0]->realVars[111] /* pwLine4.is.im variable */ + ((-data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[221] /* pwLine4.Z.im PARAM */) * (data->localData[0]->realVars[112] /* pwLine4.is.re variable */ + (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */)))));

  RELATIONHYSTERESIS(tmp32, data->localData[0]->timeValue, data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */, 8, GreaterEq);
  RELATIONHYSTERESIS(tmp33, data->localData[0]->timeValue, data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */, 9, Less);
  res[8] = ((tmp32 && tmp33)?data->localData[0]->realVars[100] /* pwLine3.ir.re variable */:data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - ((data->simulationInfo->realParameter[211] /* pwLine3.Z.re PARAM */) * (data->localData[0]->realVars[100] /* pwLine3.ir.re variable */ + (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[210] /* pwLine3.Z.im PARAM */) * (data->localData[0]->realVars[99] /* pwLine3.ir.im variable */ + ((-data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp34, data->localData[0]->timeValue, data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */, 12, GreaterEq);
  RELATIONHYSTERESIS(tmp35, data->localData[0]->timeValue, data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */, 13, Less);
  res[9] = ((tmp34 && tmp35)?data->localData[0]->realVars[110] /* pwLine4.ir.re variable */:data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - ((data->simulationInfo->realParameter[222] /* pwLine4.Z.re PARAM */) * (data->localData[0]->realVars[110] /* pwLine4.ir.re variable */ + (data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[92] /* pwLine1.vr.re variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[221] /* pwLine4.Z.im PARAM */) * (data->localData[0]->realVars[109] /* pwLine4.ir.im variable */ + ((-data->localData[0]->realVars[92] /* pwLine1.vr.re variable */)) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp36, data->localData[0]->timeValue, data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp37, data->localData[0]->timeValue, data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */, 3, Less);
  res[10] = ((tmp36 && tmp37)?data->localData[0]->realVars[88] /* pwLine1.ir.re variable */:data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - ((data->simulationInfo->realParameter[200] /* pwLine1.Z.re PARAM */) * (data->localData[0]->realVars[88] /* pwLine1.ir.re variable */ + (data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[92] /* pwLine1.vr.re variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[199] /* pwLine1.Z.im PARAM */) * (data->localData[0]->realVars[87] /* pwLine1.ir.im variable */ + ((-data->localData[0]->realVars[92] /* pwLine1.vr.re variable */)) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp38, data->localData[0]->timeValue, data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp39, data->localData[0]->timeValue, data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */, 3, Less);
  res[11] = ((tmp38 && tmp39)?data->localData[0]->realVars[87] /* pwLine1.ir.im variable */:data->localData[0]->realVars[91] /* pwLine1.vr.im variable */ - data->localData[0]->realVars[93] /* pwLine1.vs.im variable */ - ((data->simulationInfo->realParameter[200] /* pwLine1.Z.re PARAM */) * (data->localData[0]->realVars[87] /* pwLine1.ir.im variable */ + ((-data->localData[0]->realVars[92] /* pwLine1.vr.re variable */)) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))) + (data->simulationInfo->realParameter[199] /* pwLine1.Z.im PARAM */) * (data->localData[0]->realVars[88] /* pwLine1.ir.re variable */ + (data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[92] /* pwLine1.vr.re variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */)))));

  RELATIONHYSTERESIS(tmp40, data->localData[0]->timeValue, data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */, 0, GreaterEq);
  RELATIONHYSTERESIS(tmp41, data->localData[0]->timeValue, data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */, 1, Less);
  res[12] = ((tmp40 && tmp41)?data->localData[0]->realVars[80] /* pwLine.is.re variable */:data->localData[0]->realVars[82] /* pwLine.vs.re variable */ - data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - ((data->simulationInfo->realParameter[189] /* pwLine.Z.re PARAM */) * (data->localData[0]->realVars[80] /* pwLine.is.re variable */ + (data->localData[0]->realVars[81] /* pwLine.vs.im variable */) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[82] /* pwLine.vs.re variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[188] /* pwLine.Z.im PARAM */) * (data->localData[0]->realVars[79] /* pwLine.is.im variable */ + ((-data->localData[0]->realVars[82] /* pwLine.vs.re variable */)) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[81] /* pwLine.vs.im variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp42, data->localData[0]->timeValue, data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */, 0, GreaterEq);
  RELATIONHYSTERESIS(tmp43, data->localData[0]->timeValue, data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */, 1, Less);
  res[13] = ((tmp42 && tmp43)?data->localData[0]->realVars[79] /* pwLine.is.im variable */:data->localData[0]->realVars[81] /* pwLine.vs.im variable */ - data->localData[0]->realVars[93] /* pwLine1.vs.im variable */ - ((data->simulationInfo->realParameter[189] /* pwLine.Z.re PARAM */) * (data->localData[0]->realVars[79] /* pwLine.is.im variable */ + ((-data->localData[0]->realVars[82] /* pwLine.vs.re variable */)) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[81] /* pwLine.vs.im variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))) + (data->simulationInfo->realParameter[188] /* pwLine.Z.im PARAM */) * (data->localData[0]->realVars[80] /* pwLine.is.re variable */ + (data->localData[0]->realVars[81] /* pwLine.vs.im variable */) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[82] /* pwLine.vs.re variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */)))));
  ...
  RELATIONHYSTERESIS(tmp44, data->localData[0]->timeValue, data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */, 0, GreaterEq);
  RELATIONHYSTERESIS(tmp45, data->localData[0]->timeValue, data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */, 1, Less);
  res[16] = ((tmp44 && tmp45)?data->localData[0]->realVars[77] /* pwLine.ir.im variable */:data->localData[0]->realVars[93] /* pwLine1.vs.im variable */ - data->localData[0]->realVars[81] /* pwLine.vs.im variable */ - ((data->simulationInfo->realParameter[189] /* pwLine.Z.re PARAM */) * (data->localData[0]->realVars[77] /* pwLine.ir.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))) + (data->simulationInfo->realParameter[188] /* pwLine.Z.im PARAM */) * (data->localData[0]->realVars[78] /* pwLine.ir.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */)))));

  RELATIONHYSTERESIS(tmp46, data->localData[0]->timeValue, data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */, 0, GreaterEq);
  RELATIONHYSTERESIS(tmp47, data->localData[0]->timeValue, data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */, 1, Less);
  res[17] = ((tmp46 && tmp47)?data->localData[0]->realVars[78] /* pwLine.ir.re variable */:data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - data->localData[0]->realVars[82] /* pwLine.vs.re variable */ - ((data->simulationInfo->realParameter[189] /* pwLine.Z.re PARAM */) * (data->localData[0]->realVars[78] /* pwLine.ir.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[188] /* pwLine.Z.im PARAM */) * (data->localData[0]->realVars[77] /* pwLine.ir.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp48, data->localData[0]->timeValue, data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */, 8, GreaterEq);
  RELATIONHYSTERESIS(tmp49, data->localData[0]->timeValue, data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */, 9, Less);
  res[18] = ((tmp48 && tmp49)?data->localData[0]->realVars[102] /* pwLine3.is.re variable */:data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - ((data->simulationInfo->realParameter[211] /* pwLine3.Z.re PARAM */) * (data->localData[0]->realVars[102] /* pwLine3.is.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[210] /* pwLine3.Z.im PARAM */) * (data->localData[0]->realVars[101] /* pwLine3.is.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))))));

  RELATIONHYSTERESIS(tmp50, data->localData[0]->timeValue, data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */, 8, GreaterEq);
  RELATIONHYSTERESIS(tmp51, data->localData[0]->timeValue, data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */, 9, Less);
  res[19] = ((tmp50 && tmp51)?data->localData[0]->realVars[101] /* pwLine3.is.im variable */:data->localData[0]->realVars[93] /* pwLine1.vs.im variable */ - data->localData[0]->realVars[103] /* pwLine3.vr.im variable */ - ((data->simulationInfo->realParameter[211] /* pwLine3.Z.re PARAM */) * (data->localData[0]->realVars[101] /* pwLine3.is.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[210] /* pwLine3.Z.im PARAM */) * (data->localData[0]->realVars[102] /* pwLine3.is.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */)))));

  RELATIONHYSTERESIS(tmp52, data->localData[0]->timeValue, data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp53, data->localData[0]->timeValue, data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */, 3, Less);
  res[20] = ((tmp52 && tmp53)?data->localData[0]->realVars[89] /* pwLine1.is.im variable */:data->localData[0]->realVars[93] /* pwLine1.vs.im variable */ - data->localData[0]->realVars[91] /* pwLine1.vr.im variable */ - ((data->simulationInfo->realParameter[200] /* pwLine1.Z.re PARAM */) * (data->localData[0]->realVars[89] /* pwLine1.is.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))) + (data->simulationInfo->realParameter[199] /* pwLine1.Z.im PARAM */) * (data->localData[0]->realVars[90] /* pwLine1.is.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */)))));
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[4] /* gENSAL.PSIppq STATE(1) */ = ((-data->localData[0]->realVars[11] /* der(gENSAL.PSIppq) STATE_DER */)) * (data->simulationInfo->realParameter[144] /* gENSAL.Tppq0 PARAM */) - ((data->localData[0]->realVars[68] /* gENSAL.iq variable */) * (data->simulationInfo->realParameter[152] /* gENSAL.Xppq PARAM */ - data->simulationInfo->realParameter[153] /* gENSAL.Xq PARAM */));
  TRACE_POP
}
/*
equation index: 25
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[79] /* pwLine.is.im variable */ = ((sin(data->localData[0]->realVars[5] /* gENSAL.delta STATE(1) */)) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */) - ((cos(data->localData[0]->realVars[5] /* gENSAL.delta STATE(1) */)) * (data->localData[0]->realVars[67] /* gENSAL.id variable */))) * (data->simulationInfo->realParameter[102] /* gENSAL.CoB PARAM */);
  TRACE_POP
}
/*
equation index: 27
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[80] /* pwLine.is.re variable */ = ((cos(data->localData[0]->realVars[5] /* gENSAL.delta STATE(1) */)) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */) - (((-sin(data->localData[0]->realVars[5] /* gENSAL.delta STATE(1) */))) * (data->localData[0]->realVars[67] /* gENSAL.id variable */))) * (data->simulationInfo->realParameter[102] /* gENSAL.CoB PARAM */);
  TRACE_POP
}
/*
equation index: 28
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_31(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[60] /* gENSAL.PSId variable */ = data->localData[0]->realVars[70] /* gENSAL.uq variable */ + (data->simulationInfo->realParameter[136] /* gENSAL.R_a PARAM */) * (data->localData[0]->realVars[68] /* gENSAL.iq variable */);
  TRACE_POP
}
/*
equation index: 32
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_32(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[61] /* gENSAL.PSIppd variable */ = data->localData[0]->realVars[60] /* gENSAL.PSId variable */ + (data->simulationInfo->realParameter[151] /* gENSAL.Xppd PARAM */) * (data->localData[0]->realVars[67] /* gENSAL.id variable */);
  TRACE_POP
}
/*
equation index: 33
...
void residualFunc68(void** dataIn, const double* xloc, double* res, const int* iflag)
{
  ...
  /* body */
  tmp0 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[179] /* pwFault.t1 PARAM */);
  tmp9 = (modelica_boolean)tmp0;
  if(tmp9)
  {
  ...
  {
    tmp1 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */);
    tmp7 = (modelica_boolean)(tmp1 && data->simulationInfo->booleanParameter[63] /* pwFault.ground PARAM */);
    if(tmp7)
    {
    ...
    {
      tmp2 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */);
      tmp5 = (modelica_boolean)tmp2;
      if(tmp5)
      {
        tmp3 = data->simulationInfo->realParameter[178] /* pwFault.X PARAM */;
        tmp4 = data->simulationInfo->realParameter[177] /* pwFault.R PARAM */;
  ...
  tmp11 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[179] /* pwFault.t1 PARAM */);
  tmp20 = (modelica_boolean)tmp11;
  if(tmp20)
  {
  ...
  {
    tmp12 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */);
    tmp18 = (modelica_boolean)(tmp12 && data->simulationInfo->booleanParameter[63] /* pwFault.ground PARAM */);
    if(tmp18)
    {
    ...
    {
      tmp13 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[180] /* pwFault.t2 PARAM */);
      tmp16 = (modelica_boolean)tmp13;
      if(tmp16)
      {
        tmp14 = data->simulationInfo->realParameter[177] /* pwFault.R PARAM */;
        tmp15 = data->simulationInfo->realParameter[178] /* pwFault.X PARAM */;
        tmp17 = data->localData[0]->realVars[72] /* pwFault.p.ir variable */ - (DIVISION_SIM((data->simulationInfo->realParameter[177] /* pwFault.R PARAM */) * (data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) + (data->simulationInfo->realParameter[178] /* pwFault.X PARAM */) * (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */),(tmp14 * tmp14) + (tmp15 * tmp15),"pwFault.R ^ 2.0 + pwFault.X ^ 2.0",equationIndexes));
      }
      else
      {
  ...
  tmp22 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */);
  tmp23 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */);
  res[2] = ((tmp22 && tmp23)?data->localData[0]->realVars[112] /* pwLine4.is.re variable */:data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - ((data->simulationInfo->realParameter[222] /* pwLine4.Z.re PARAM */) * (data->localData[0]->realVars[112] /* pwLine4.is.re variable */ + (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[221] /* pwLine4.Z.im PARAM */) * (data->localData[0]->realVars[111] /* pwLine4.is.im variable */ + ((-data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))))));

  tmp24 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */);
  tmp25 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */);
  ...
  tmp26 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */);
  tmp27 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */);
  ...
  tmp28 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[223] /* pwLine4.t1 PARAM */);
  tmp29 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[224] /* pwLine4.t2 PARAM */);
  res[7] = ((tmp28 && tmp29)?data->localData[0]->realVars[110] /* pwLine4.ir.re variable */:data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - ((data->simulationInfo->realParameter[222] /* pwLine4.Z.re PARAM */) * (data->localData[0]->realVars[110] /* pwLine4.ir.re variable */ + (data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[92] /* pwLine1.vr.re variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))) - ((data->simulationInfo->realParameter[221] /* pwLine4.Z.im PARAM */) * (data->localData[0]->realVars[109] /* pwLine4.ir.im variable */ + ((-data->localData[0]->realVars[92] /* pwLine1.vr.re variable */)) * (data->simulationInfo->realParameter[219] /* pwLine4.Y.im PARAM */) - ((data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[220] /* pwLine4.Y.re PARAM */))))));

  tmp30 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */);
  tmp31 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */);
  ...
  tmp32 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */);
  tmp33 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */);
  res[9] = ((tmp32 && tmp33)?data->localData[0]->realVars[100] /* pwLine3.ir.re variable */:data->localData[0]->realVars[104] /* pwLine3.vr.re variable */ - data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - ((data->simulationInfo->realParameter[211] /* pwLine3.Z.re PARAM */) * (data->localData[0]->realVars[100] /* pwLine3.ir.re variable */ + (data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[104] /* pwLine3.vr.re variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))) - ((data->simulationInfo->realParameter[210] /* pwLine3.Z.im PARAM */) * (data->localData[0]->realVars[99] /* pwLine3.ir.im variable */ + ((-data->localData[0]->realVars[104] /* pwLine3.vr.re variable */)) * (data->simulationInfo->realParameter[208] /* pwLine3.Y.im PARAM */) - ((data->localData[0]->realVars[103] /* pwLine3.vr.im variable */) * (data->simulationInfo->realParameter[209] /* pwLine3.Y.re PARAM */))))));

  tmp34 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */);
  tmp35 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */);
  ...
  tmp36 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[212] /* pwLine3.t1 PARAM */);
  tmp37 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[213] /* pwLine3.t2 PARAM */);
  ...
  tmp38 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */);
  tmp39 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */);
  ...
  tmp40 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */);
  tmp41 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */);
  ...
  tmp42 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */);
  tmp43 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */);
  ...
  tmp44 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[201] /* pwLine1.t1 PARAM */);
  tmp45 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[202] /* pwLine1.t2 PARAM */);
  res[15] = ((tmp44 && tmp45)?data->localData[0]->realVars[88] /* pwLine1.ir.re variable */:data->localData[0]->realVars[92] /* pwLine1.vr.re variable */ - data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - ((data->simulationInfo->realParameter[200] /* pwLine1.Z.re PARAM */) * (data->localData[0]->realVars[88] /* pwLine1.ir.re variable */ + (data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[92] /* pwLine1.vr.re variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))) - ((data->simulationInfo->realParameter[199] /* pwLine1.Z.im PARAM */) * (data->localData[0]->realVars[87] /* pwLine1.ir.im variable */ + ((-data->localData[0]->realVars[92] /* pwLine1.vr.re variable */)) * (data->simulationInfo->realParameter[197] /* pwLine1.Y.im PARAM */) - ((data->localData[0]->realVars[91] /* pwLine1.vr.im variable */) * (data->simulationInfo->realParameter[198] /* pwLine1.Y.re PARAM */))))));

  tmp46 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */);
  tmp47 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */);
  ...
  tmp48 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */);
  tmp49 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */);
  ...
  tmp50 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */);
  tmp51 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */);
  ...
  tmp52 = GreaterEq(data->localData[0]->timeValue,data->simulationInfo->realParameter[190] /* pwLine.t1 PARAM */);
  tmp53 = Less(data->localData[0]->timeValue,data->simulationInfo->realParameter[191] /* pwLine.t2 PARAM */);
  res[21] = ((tmp52 && tmp53)?data->localData[0]->realVars[78] /* pwLine.ir.re variable */:data->localData[0]->realVars[94] /* pwLine1.vs.re variable */ - data->localData[0]->realVars[82] /* pwLine.vs.re variable */ - ((data->simulationInfo->realParameter[189] /* pwLine.Z.re PARAM */) * (data->localData[0]->realVars[78] /* pwLine.ir.re variable */ + (data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[94] /* pwLine1.vs.re variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[188] /* pwLine.Z.im PARAM */) * (data->localData[0]->realVars[77] /* pwLine.ir.im variable */ + ((-data->localData[0]->realVars[94] /* pwLine1.vs.re variable */)) * (data->simulationInfo->realParameter[186] /* pwLine.Y.im PARAM */) - ((data->localData[0]->realVars[93] /* pwLine1.vs.im variable */) * (data->simulationInfo->realParameter[187] /* pwLine.Y.re PARAM */))))));

  res[22] = (data->localData[0]->realVars[3] /* gENSAL.PSIkd STATE(1) */) * (data->simulationInfo->realParameter[121] /* gENSAL.K4d PARAM */) + (data->localData[0]->realVars[2] /* gENSAL.Epq STATE(1) */) * (data->simulationInfo->realParameter[120] /* gENSAL.K3d PARAM */) - data->localData[0]->realVars[61] /* gENSAL.PSIppd variable */;

  res[23] = data->localData[0]->realVars[2] /* gENSAL.Epq STATE(1) */ + (data->simulationInfo->realParameter[149] /* gENSAL.Xl PARAM */ - data->simulationInfo->realParameter[150] /* gENSAL.Xpd PARAM */) * (data->localData[0]->realVars[67] /* gENSAL.id variable */) + (-data->localData[0]->realVars[3] /* gENSAL.PSIkd STATE(1) */) - ((data->localData[0]->realVars[10] /* der(gENSAL.PSIkd) STATE_DER */) * (data->simulationInfo->realParameter[143] /* gENSAL.Tppd0 PARAM */));
  /* restore known outputs */
  TRACE_POP
}
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[1].analyticalJacobianColumn = OpenIPSL_Examples_Machines_PSSE_GENSAL_functionJacNLSJac3_column;
  nonLinearSystemData[1].initialAnalyticalJacobian = OpenIPSL_Examples_Machines_PSSE_GENSAL_initialAnalyticJacobianNLSJac3;
