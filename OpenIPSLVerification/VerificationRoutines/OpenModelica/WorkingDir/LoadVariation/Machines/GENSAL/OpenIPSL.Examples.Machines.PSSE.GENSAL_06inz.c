...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_14(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[5] /* gENSAL.delta STATE(1) */ = data->simulationInfo->realParameter[160] /* gENSAL.delta0 PARAM */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[57] /* gENSAL.ISORCE variable */ = data->simulationInfo->realParameter[162] /* gENSAL.efd0 PARAM */ - ((data->localData[0]->realVars[9] /* der(gENSAL.Epq) STATE_DER */) * (data->simulationInfo->realParameter[142] /* gENSAL.Tpd0 PARAM */));
  TRACE_POP
}
...
vars: {pwLine.ir.re, pwLine1.is.re, pwLine.ir.im, pwLine1.is.im, pwLine3.is.im, pwLine3.is.re, pwLine4.is.re, pwLine3.ir.re, pwLine4.is.im, pwLine3.ir.im, pwLine4.ir.re, pwLine1.ir.im, gENCLS.id, gENCLS.iq, pwLine1.vr.re, pwLine1.vr.im, gENSAL.Epq, gENSAL.uq, gENSAL.id, gENSAL.iq, pwLine1.vs.re, pwLine1.vs.im, pwLine3.vr.im, pwLine3.vr.re}
...
void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_68(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[14] = data->simulationInfo->realParameter[101] /* gENCLS.vr0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[15] = data->simulationInfo->realParameter[99] /* gENCLS.vi0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[16] = data->simulationInfo->realParameter[108] /* gENSAL.Epq0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[17] = data->simulationInfo->realParameter[172] /* gENSAL.uq0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[18] = data->simulationInfo->realParameter[164] /* gENSAL.id0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[19] = data->simulationInfo->realParameter[166] /* gENSAL.iq0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[20] = data->simulationInfo->realParameter[74] /* constantLoad.vr0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[21] = data->simulationInfo->realParameter[73] /* constantLoad.vi0 PARAM */;
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[22] = (data->simulationInfo->realParameter[7] /* FAULT.v_0 PARAM */) * (sin(data->simulationInfo->realParameter[5] /* FAULT.angle_0rad PARAM */));
  data->simulationInfo->nonlinearSystemData[0].nlsxOld[23] = (data->simulationInfo->realParameter[7] /* FAULT.v_0 PARAM */) * (cos(data->simulationInfo->realParameter[5] /* FAULT.angle_0rad PARAM */));
