...
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_SCRX_INDEX_JAC_NLSJac25 0
  int OpenIPSL_Examples_Controls_PSSE_ES_SCRX_functionJacNLSJac25_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int OpenIPSL_Examples_Controls_PSSE_ES_SCRX_initialAnalyticJacobianNLSJac25(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
