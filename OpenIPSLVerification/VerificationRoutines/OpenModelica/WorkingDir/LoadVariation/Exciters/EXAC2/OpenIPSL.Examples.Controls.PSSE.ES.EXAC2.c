...
eqns: {792, 793, 794, 795, 796, 797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 836, 835, 834, 833, 832, 831, 830, 829, 828, 827, 826, 825, 824, 823, 822, 821, 820, 819, 818, 817, 816, 815}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_eqFunction_882(DATA *data, threadData_t *threadData)
{
  ...
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 882 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  if (retValue > 0){
    const int indexes[2] = {1,882};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 882 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
extern void OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_eqFunction_779(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_eqFunction_780(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_eqFunction_781(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_eqFunction_782(DATA* data, threadData_t *threadData);
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{d52ead79-a4e3-4bfa-b90e-f2a9d234ac9e}";
  ...
  data->modelData->modelDataXml.nEquations = 1236;
