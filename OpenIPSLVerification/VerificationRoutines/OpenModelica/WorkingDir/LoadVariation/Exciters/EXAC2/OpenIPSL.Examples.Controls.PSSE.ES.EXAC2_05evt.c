...
const char *OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs20[] = {1,887};
  static const int occurEqs21[] = {1,887};
  static const int occurEqs22[] = {1,887};
  static const int occurEqs23[] = {1,887};
  static const int occurEqs24[] = {1,907};
  static const int occurEqs25[] = {1,911};
  static const int occurEqs26[] = {1,912};
  static const int occurEqs27[] = {1,913};
...
int OpenIPSL_Examples_Controls_PSSE_ES_EXAC2_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  gout[10] = ((tmp14 && data->simulationInfo->booleanParameter[68] /* pwFault.ground PARAM */)) ? 1 : -1;
