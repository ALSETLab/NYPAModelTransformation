  ...
  extern "C" {
#endif
  int OpenIPSL_Examples_Controls_PSSE_ES_ESAC2A_mayer(DATA* data, modelica_real** res, short*);
  int OpenIPSL_Examples_Controls_PSSE_ES_ESAC2A_lagrange(DATA* data, modelica_real** res, short *, short *);
