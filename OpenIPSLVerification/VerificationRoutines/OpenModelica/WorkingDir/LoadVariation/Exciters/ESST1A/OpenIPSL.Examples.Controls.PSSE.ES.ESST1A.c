...
eqns: {796, 797, 798, 799, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814, 815, 816, 817, 818, 840, 839, 838, 837, 836, 835, 834, 833, 832, 831, 830, 829, 828, 827, 826, 825, 824, 823, 822, 821, 820, 819}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_886(DATA *data, threadData_t *threadData)
{
  ...
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 886 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  if (retValue > 0){
    const int indexes[2] = {1,886};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 886 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_888(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_889(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_910(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_911(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_912(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_913(DATA*, threadData_t*);
...
eqns: {910, 911, 912, 913, 914, 915, 916, 917, 918, 919}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_930(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 930 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,930};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 930 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
int OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_functionDAE(DATA *data, threadData_t *threadData)
{
  ...
  OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_888(data, threadData);

  OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_889(data, threadData);
...
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_785(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_886(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_887(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_888(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_eqFunction_889(DATA* data, threadData_t *threadData);
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{c2c36750-b214-4f6d-acc5-726da77835f7}";
  ...
  data->modelData->modelDataXml.nEquations = 1265;
