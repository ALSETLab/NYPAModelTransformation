...
const char *OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs21[] = {1,936};
  static const int occurEqs22[] = {1,937};
  static const int occurEqs23[] = {1,934};
  static const int occurEqs24[] = {1,935};
  static const int occurEqs25[] = {1,787};
  static const int occurEqs26[] = {1,787};
