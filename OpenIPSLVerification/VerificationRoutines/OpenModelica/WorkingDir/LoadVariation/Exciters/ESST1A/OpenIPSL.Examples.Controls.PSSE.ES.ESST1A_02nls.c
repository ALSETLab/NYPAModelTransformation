...
void residualFunc930(void** dataIn, const double* xloc, double* res, const int* iflag)
{
  TRACE_PUSH
...
void initializeSparsePatternNLS930(NONLINEAR_SYSTEM_DATA* inSysData)
{
  int i=0;
...
void initializeStaticDataNLS930(void *inData, threadData_t *threadData, void *inSystemData)
{
  ...
  initializeSparsePatternNLS930(sysData);
}

void getIterationVarsNLS930(struct DATA *inData, double *array)
{
  DATA* data = (DATA*) inData;
...
void initializeSparsePatternNLS886(NONLINEAR_SYSTEM_DATA* inSysData)
{
  int i=0;
...
void initializeStaticDataNLS886(void *inData, threadData_t *threadData, void *inSystemData)
{
  DATA* data = (DATA*) inData;
  NONLINEAR_SYSTEM_DATA* sysData = (NONLINEAR_SYSTEM_DATA*) inSystemData;
  int i=0;
  ...
  /* initial sparse pattern */
  initializeSparsePatternNLS886(sysData);
}

void getIterationVarsNLS886(struct DATA *inData, double *array)
{
  DATA* data = (DATA*) inData;
...
void residualFunc710(void** dataIn, const double* xloc, double* res, const int* iflag)
{
  TRACE_PUSH
  DATA *data = (DATA*) ((void**)dataIn[0]);
  threadData_t *threadData = (threadData_t*) ((void**)dataIn[1]);
...
void initializeSparsePatternNLS710(NONLINEAR_SYSTEM_DATA* inSysData)
{
  int i=0;
...
void initializeStaticDataNLS710(void *inData, threadData_t *threadData, void *inSystemData)
{
  DATA* data = (DATA*) inData;
  NONLINEAR_SYSTEM_DATA* sysData = (NONLINEAR_SYSTEM_DATA*) inSystemData;
  int i=0;
  ...
  sysData->max[i++]   = data->modelData->realVarsData[134].attribute /* pwLine1.vs.im */.max;
  /* initial sparse pattern */
  initializeSparsePatternNLS710(sysData);
}

void getIterationVarsNLS710(struct DATA *inData, double *array)
{
  DATA* data = (DATA*) inData;
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[3].equationIndex = 930;
  nonLinearSystemData[3].size = 1;
  nonLinearSystemData[3].homotopySupport = 0;
  nonLinearSystemData[3].mixedSystem = 1;
  nonLinearSystemData[3].residualFunc = residualFunc930;
  nonLinearSystemData[3].strictTearingFunctionCall = NULL;
  nonLinearSystemData[3].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_functionJacNLSJac10_column;
  nonLinearSystemData[3].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_initialAnalyticJacobianNLSJac10;
  nonLinearSystemData[3].jacobianIndex = 1 /*jacInx*/;
  nonLinearSystemData[3].initializeStaticNLSData = initializeStaticDataNLS930;
  nonLinearSystemData[3].getIterationVars = getIterationVarsNLS930;
  nonLinearSystemData[3].checkConstraints = NULL;
  
  
  nonLinearSystemData[2].equationIndex = 886;
  nonLinearSystemData[2].size = 22;
  nonLinearSystemData[2].homotopySupport = 0;
  nonLinearSystemData[2].mixedSystem = 1;
  nonLinearSystemData[2].residualFunc = residualFunc886;
  nonLinearSystemData[2].strictTearingFunctionCall = NULL;
  nonLinearSystemData[2].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_functionJacNLSJac9_column;
  nonLinearSystemData[2].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_ES_ESST1A_initialAnalyticJacobianNLSJac9;
  nonLinearSystemData[2].jacobianIndex = 0 /*jacInx*/;
  nonLinearSystemData[2].initializeStaticNLSData = initializeStaticDataNLS886;
  nonLinearSystemData[2].getIterationVars = getIterationVarsNLS886;
  nonLinearSystemData[2].checkConstraints = NULL;
  
  
  nonLinearSystemData[1].equationIndex = 710;
  nonLinearSystemData[1].size = 30;
  nonLinearSystemData[1].homotopySupport = 0;
  nonLinearSystemData[1].mixedSystem = 1;
  nonLinearSystemData[1].residualFunc = residualFunc710;
  nonLinearSystemData[1].strictTearingFunctionCall = NULL;
  nonLinearSystemData[1].analyticalJacobianColumn = NULL;
  nonLinearSystemData[1].initialAnalyticalJacobian = NULL;
  nonLinearSystemData[1].jacobianIndex = -1;
  nonLinearSystemData[1].initializeStaticNLSData = initializeStaticDataNLS710;
  nonLinearSystemData[1].getIterationVars = getIterationVarsNLS710;
