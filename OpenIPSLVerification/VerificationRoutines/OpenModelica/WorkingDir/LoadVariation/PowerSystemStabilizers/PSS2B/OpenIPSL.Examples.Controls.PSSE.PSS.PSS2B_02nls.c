...
void OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[3].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_functionJacNLSJac13_column;
  nonLinearSystemData[3].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_initialAnalyticJacobianNLSJac13;
  ...
  nonLinearSystemData[2].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_functionJacNLSJac12_column;
  nonLinearSystemData[2].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_PSS_PSS2B_initialAnalyticJacobianNLSJac12;
