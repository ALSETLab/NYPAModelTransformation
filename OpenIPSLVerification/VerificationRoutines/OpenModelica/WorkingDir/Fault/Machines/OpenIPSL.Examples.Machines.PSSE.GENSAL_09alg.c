...
extern void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_215(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_216(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_231(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_236(DATA* data, threadData_t *threadData);
...
extern void OpenIPSL_Examples_Machines_PSSE_GENSAL_eqFunction_252(DATA* data, threadData_t *threadData);
...
int OpenIPSL_Examples_Machines_PSSE_GENSAL_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  OpenIPSL_Examples_Machines_PSSE_GENSAL_function_savePreSynchronous(data, threadData);
