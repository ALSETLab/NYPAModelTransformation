...
extern "C" {
#endif
  #define OpenIPSL_Examples_Machines_PSSE_GENSAL_INDEX_JAC_NLSJac8 0
  int OpenIPSL_Examples_Machines_PSSE_GENSAL_functionJacNLSJac8_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int OpenIPSL_Examples_Machines_PSSE_GENSAL_initialAnalyticJacobianNLSJac8(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
extern "C" {
#endif
  #define OpenIPSL_Examples_Machines_PSSE_GENSAL_INDEX_JAC_D 1
...
extern "C" {
#endif
  #define OpenIPSL_Examples_Machines_PSSE_GENSAL_INDEX_JAC_C 2
...
extern "C" {
#endif
  #define OpenIPSL_Examples_Machines_PSSE_GENSAL_INDEX_JAC_B 3
...
extern "C" {
#endif
  #define OpenIPSL_Examples_Machines_PSSE_GENSAL_INDEX_JAC_A 4
