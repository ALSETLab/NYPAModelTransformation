...
{
  return "model linear_OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1\n  parameter Integer n = 5 \"number of states\";\n  parameter Integer m = 0 \"number of inputs\";\n  parameter Integer p = 0 \"number of outputs\";\n"
  "\n"
  ...
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\nend linear_OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1;\n";
}
const char *OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1_linear_model_datarecovery_frame()
{
  return "model linear_OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1\n  parameter Integer n = 5 \"number of states\";\n  parameter Integer m = 0 \"number of inputs\";\n  parameter Integer p = 0 \"number of outputs\";\n  parameter Integer nz = 75 \"data recovery variables\";\n"
  "\n"
  "  parameter Real x0[5] = %s;\n"
  "  parameter Real u0[0] = %s;\n"
  "  parameter Real z0[75] = %s;\n"
  "\n"
  "  parameter Real A[n, n] =\n\t[%s];\n\n"
  "  parameter Real B[n, m] = zeros(n, m);%s\n\n"
  "  parameter Real C[p, n] = zeros(p, n);%s\n\n"
