...
const char *OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs17[] = {1,416};
...
int OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  gout[9] = (tmp13) ? 1 : -1;
  tmp14 = LessZC(data->localData[0]->realVars[82] /* wT4G1.V variable */, 0.4, data->simulationInfo->storedRelations[8]);
  gout[10] = (tmp14) ? 1 : -1;
  tmp15 = GreaterZC(data->localData[0]->realVars[82] /* wT4G1.V variable */, 0.8, data->simulationInfo->storedRelations[9]);
  gout[11] = (tmp15) ? 1 : -1;
  tmp16 = LessZC(data->localData[0]->realVars[79] /* wT4G1.K2.y variable */, data->simulationInfo->realParameter[143] /* wT4G1.lVPL.VLVPL1 PARAM */, data->simulationInfo->storedRelations[10]);
  gout[12] = (tmp16) ? 1 : -1;
  tmp17 = GreaterZC(data->localData[0]->realVars[79] /* wT4G1.K2.y variable */, data->simulationInfo->realParameter[144] /* wT4G1.lVPL.VLVPL2 PARAM */, data->simulationInfo->storedRelations[11]);
  gout[13] = (tmp17) ? 1 : -1;
  tmp18 = GreaterZC(data->localData[0]->realVars[82] /* wT4G1.V variable */, data->simulationInfo->realParameter[134] /* wT4G1.hVRCL.VHVRCR PARAM */, data->simulationInfo->storedRelations[12]);
  gout[14] = (tmp18) ? 1 : -1;
  ...
  gout[16] = (tmp20) ? 1 : -1;
  tmp21 = GreaterZC(data->localData[0]->realVars[2] /* wT4G1.K.y STATE(1) */, data->localData[0]->realVars[84] /* wT4G1.lVPL.LVPL variable */, data->simulationInfo->storedRelations[13]);
  gout[17] = (tmp21) ? 1 : -1;
...
int OpenIPSL_Examples_Wind_PSSE_WT4G_WT4G1_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    ...
    tmp30 = LessZC(data->localData[0]->realVars[82] /* wT4G1.V variable */, 0.4, data->simulationInfo->storedRelations[8]);
    data->simulationInfo->relations[8] = tmp30;
    tmp31 = GreaterZC(data->localData[0]->realVars[82] /* wT4G1.V variable */, 0.8, data->simulationInfo->storedRelations[9]);
    data->simulationInfo->relations[9] = tmp31;
    tmp32 = LessZC(data->localData[0]->realVars[79] /* wT4G1.K2.y variable */, data->simulationInfo->realParameter[143] /* wT4G1.lVPL.VLVPL1 PARAM */, data->simulationInfo->storedRelations[10]);
    data->simulationInfo->relations[10] = tmp32;
    tmp33 = GreaterZC(data->localData[0]->realVars[79] /* wT4G1.K2.y variable */, data->simulationInfo->realParameter[144] /* wT4G1.lVPL.VLVPL2 PARAM */, data->simulationInfo->storedRelations[11]);
    data->simulationInfo->relations[11] = tmp33;
    tmp34 = GreaterZC(data->localData[0]->realVars[82] /* wT4G1.V variable */, data->simulationInfo->realParameter[134] /* wT4G1.hVRCL.VHVRCR PARAM */, data->simulationInfo->storedRelations[12]);
    data->simulationInfo->relations[12] = tmp34;
    tmp35 = GreaterZC(data->localData[0]->realVars[2] /* wT4G1.K.y STATE(1) */, data->localData[0]->realVars[84] /* wT4G1.lVPL.LVPL variable */, data->simulationInfo->storedRelations[13]);
    ...
    data->simulationInfo->relations[8] = (data->localData[0]->realVars[82] /* wT4G1.V variable */ < 0.4);
    data->simulationInfo->relations[9] = (data->localData[0]->realVars[82] /* wT4G1.V variable */ > 0.8);
    data->simulationInfo->relations[10] = (data->localData[0]->realVars[79] /* wT4G1.K2.y variable */ < data->simulationInfo->realParameter[143] /* wT4G1.lVPL.VLVPL1 PARAM */);
    data->simulationInfo->relations[11] = (data->localData[0]->realVars[79] /* wT4G1.K2.y variable */ > data->simulationInfo->realParameter[144] /* wT4G1.lVPL.VLVPL2 PARAM */);
    data->simulationInfo->relations[12] = (data->localData[0]->realVars[82] /* wT4G1.V variable */ > data->simulationInfo->realParameter[134] /* wT4G1.hVRCL.VHVRCR PARAM */);
    data->simulationInfo->relations[13] = (data->localData[0]->realVars[2] /* wT4G1.K.y STATE(1) */ > data->localData[0]->realVars[84] /* wT4G1.lVPL.LVPL variable */);
  }
