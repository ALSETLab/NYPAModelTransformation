...
equation index: 201
type: SIMPLE_ASSIGN
constantLoad.kI.$pDERNLSJac40.dummyVarNLSJac40 = if constantLoad.v < 0.5 then constantLoad.a2 * constantLoad.b2 * (constantLoad.v ^ (-1.0 + constantLoad.b2) * (-exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) * constantLoad.a2 * (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (constantLoad.b2 - 1.0) * constantLoad.b2 * constantLoad.v.$pDERNLSJac40.dummyVarNLSJac40) + (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (-1.0 + constantLoad.b2 - 1.0) * (-1.0 + constantLoad.b2) * constantLoad.v.$pDERNLSJac40.dummyVarNLSJac40) * exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) else 0.0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_201(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp44)
  {
    ...
    else
    {
      ...
      tmp26 = (tmp20) * ((data->simulationInfo->realParameter[66] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */));
    }
    ...
    else
    {
      ...
      tmp36 = (tmp30) * ((-1.0 + data->simulationInfo->realParameter[66] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */));
    }
  ...
  jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */ = tmp45;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_224(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp65)
  {
    tmp66 = jacobian->tmpVars[20] /* pwFault.p.ii.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp63)
    {
      tmp64 = jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac40 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp61)
      {
        ...
        tmp62 = jacobian->tmpVars[20] /* pwFault.p.ii.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[191] /* pwFault.R PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */) - ((data->simulationInfo->realParameter[192] /* pwFault.X PARAM */) * (jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac40 SEED_VAR */))) * ((tmp56 * tmp56) + (tmp57 * tmp57)),(tmp60 * tmp60),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp62 = jacobian->tmpVars[20] /* pwFault.p.ii.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */;
      }
      tmp64 = tmp62;
    }
    tmp66 = tmp64;
  }
  jacobian->resultVars[1] /* $res2.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_VAR */ = tmp66;
  TRACE_POP
}
...
equation index: 225
type: SIMPLE_ASSIGN
$res3.$pDERNLSJac40.dummyVarNLSJac40 = if time < pwFault.t1 then pwFault.p.ir.$pDERNLSJac40.dummyVarNLSJac40 else if time < pwFault.t2 and pwFault.ground then pwLine3.vr.im.SeedNLSJac40 else if time < pwFault.t2 then pwFault.p.ir.$pDERNLSJac40.dummyVarNLSJac40 - (pwFault.R * pwLine3.vr.re.SeedNLSJac40 + pwFault.X * pwLine3.vr.im.SeedNLSJac40) * (pwFault.R ^ 2.0 + pwFault.X ^ 2.0) / (pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0 else pwFault.p.ir.$pDERNLSJac40.dummyVarNLSJac40
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_225(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp79)
  {
    tmp80 = jacobian->tmpVars[19] /* pwFault.p.ir.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp77)
    {
      tmp78 = jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp75)
      {
        ...
        tmp76 = jacobian->tmpVars[19] /* pwFault.p.ir.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[191] /* pwFault.R PARAM */) * (jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac40 SEED_VAR */) + (data->simulationInfo->realParameter[192] /* pwFault.X PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */)) * ((tmp70 * tmp70) + (tmp71 * tmp71)),(tmp74 * tmp74),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp76 = jacobian->tmpVars[19] /* pwFault.p.ir.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */;
      }
      tmp78 = tmp76;
    }
    tmp80 = tmp78;
  }
  jacobian->resultVars[2] /* $res3.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_VAR */ = tmp80;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_227(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[4] /* $res5.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_VAR */ = ((tmp83 && tmp84)?jacobian->seedVars[6] /* pwLine4.is.im.SeedNLSJac40 SEED_VAR */:jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac40 SEED_VAR */ - ((data->simulationInfo->realParameter[236] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[6] /* pwLine4.is.im.SeedNLSJac40 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac40 SEED_VAR */)) * (data->simulationInfo->realParameter[233] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */) * (data->simulationInfo->realParameter[234] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[235] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[8] /* pwLine4.is.re.SeedNLSJac40 SEED_VAR */ + (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */) * (data->simulationInfo->realParameter[233] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac40 SEED_VAR */) * (data->simulationInfo->realParameter[234] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 228
type: SIMPLE_ASSIGN
$res6.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine3.t1 and time < pwLine3.t2 then pwLine3.ir.im.SeedNLSJac40 else pwLine3.vr.im.SeedNLSJac40 - pwLine1.vs.im.SeedNLSJac40 - (pwLine3.Z.re * (pwLine3.ir.im.SeedNLSJac40 + (-pwLine3.vr.re.SeedNLSJac40) * pwLine3.Y.im - pwLine3.vr.im.SeedNLSJac40 * pwLine3.Y.re) + pwLine3.Z.im * (pwLine3.ir.re.SeedNLSJac40 + pwLine3.vr.im.SeedNLSJac40 * pwLine3.Y.im - pwLine3.vr.re.SeedNLSJac40 * pwLine3.Y.re))
*/
...
equation index: 230
type: SIMPLE_ASSIGN
$res8.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.im.$pDERNLSJac40.dummyVarNLSJac40 else pwLine.vs.im.$pDERNLSJac40.dummyVarNLSJac40 - pwLine1.vs.im.SeedNLSJac40 - (pwLine.Z.re * (pwLine.is.im.$pDERNLSJac40.dummyVarNLSJac40 + (-pwLine.vs.re.$pDERNLSJac40.dummyVarNLSJac40) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac40.dummyVarNLSJac40 * pwLine.Y.re) + pwLine.Z.im * (pwLine.is.re.$pDERNLSJac40.dummyVarNLSJac40 + pwLine.vs.im.$pDERNLSJac40.dummyVarNLSJac40 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac40.dummyVarNLSJac40 * pwLine.Y.re))
*/
...
equation index: 231
type: SIMPLE_ASSIGN
$res9.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.re.$pDERNLSJac40.dummyVarNLSJac40 else pwLine.vs.re.$pDERNLSJac40.dummyVarNLSJac40 - pwLine1.vs.re.SeedNLSJac40 - (pwLine.Z.re * (pwLine.is.re.$pDERNLSJac40.dummyVarNLSJac40 + pwLine.vs.im.$pDERNLSJac40.dummyVarNLSJac40 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac40.dummyVarNLSJac40 * pwLine.Y.re) - pwLine.Z.im * (pwLine.is.im.$pDERNLSJac40.dummyVarNLSJac40 + (-pwLine.vs.re.$pDERNLSJac40.dummyVarNLSJac40) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac40.dummyVarNLSJac40 * pwLine.Y.re))
*/
...
equation index: 232
type: SIMPLE_ASSIGN
$res10.$pDERNLSJac40.dummyVarNLSJac40 = pwLine1.vs.im * constantLoad.p.ir.SeedNLSJac40 + pwLine1.vs.im.SeedNLSJac40 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac40) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac40.dummyVarNLSJac40 - pwLine1.vs.re * constantLoad.p.ii.SeedNLSJac40
*/
...
equation index: 233
type: SIMPLE_ASSIGN
$res11.$pDERNLSJac40.dummyVarNLSJac40 = pwLine1.vs.im * constantLoad.p.ii.SeedNLSJac40 + pwLine1.vs.im.SeedNLSJac40 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.SeedNLSJac40 + pwLine1.vs.re.SeedNLSJac40 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac40.dummyVarNLSJac40
*/
...
equation index: 234
type: SIMPLE_ASSIGN
$res12.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.im.$pDERNLSJac40.dummyVarNLSJac40 else pwLine1.vs.im.SeedNLSJac40 - pwLine.vs.im.$pDERNLSJac40.dummyVarNLSJac40 - (pwLine.Z.re * (pwLine.ir.im.$pDERNLSJac40.dummyVarNLSJac40 + (-pwLine1.vs.re.SeedNLSJac40) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac40 * pwLine.Y.re) + pwLine.Z.im * (pwLine.ir.re.SeedNLSJac40 + pwLine1.vs.im.SeedNLSJac40 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac40 * pwLine.Y.re))
*/
...
equation index: 235
type: SIMPLE_ASSIGN
$res13.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.re.SeedNLSJac40 else pwLine1.vs.re.SeedNLSJac40 - pwLine.vs.re.$pDERNLSJac40.dummyVarNLSJac40 - (pwLine.Z.re * (pwLine.ir.re.SeedNLSJac40 + pwLine1.vs.im.SeedNLSJac40 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac40 * pwLine.Y.re) - pwLine.Z.im * (pwLine.ir.im.$pDERNLSJac40.dummyVarNLSJac40 + (-pwLine1.vs.re.SeedNLSJac40) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac40 * pwLine.Y.re))
*/
...
equation index: 236
type: SIMPLE_ASSIGN
$res14.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine3.t1 and time < pwLine3.t2 then pwLine3.is.im.SeedNLSJac40 else pwLine1.vs.im.SeedNLSJac40 - pwLine3.vr.im.SeedNLSJac40 - (pwLine3.Z.re * (pwLine3.is.im.SeedNLSJac40 + (-pwLine1.vs.re.SeedNLSJac40) * pwLine3.Y.im - pwLine1.vs.im.SeedNLSJac40 * pwLine3.Y.re) + pwLine3.Z.im * (pwLine3.is.re.$pDERNLSJac40.dummyVarNLSJac40 + pwLine1.vs.im.SeedNLSJac40 * pwLine3.Y.im - pwLine1.vs.re.SeedNLSJac40 * pwLine3.Y.re))
*/
...
equation index: 238
type: SIMPLE_ASSIGN
$res16.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.is.im.SeedNLSJac40 else pwLine1.vs.im.SeedNLSJac40 - pwLine1.vr.im.SeedNLSJac40 - (pwLine1.Z.re * (pwLine1.is.im.SeedNLSJac40 + (-pwLine1.vs.re.SeedNLSJac40) * pwLine1.Y.im - pwLine1.vs.im.SeedNLSJac40 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.is.re.SeedNLSJac40 + pwLine1.vs.im.SeedNLSJac40 * pwLine1.Y.im - pwLine1.vs.re.SeedNLSJac40 * pwLine1.Y.re))
*/
...
equation index: 240
type: SIMPLE_ASSIGN
$res18.$pDERNLSJac40.dummyVarNLSJac40 = $cse1 * gENCLS.vq.$pDERNLSJac40.dummyVarNLSJac40 + (-$cse2) * gENCLS.vd.$pDERNLSJac40.dummyVarNLSJac40 - pwLine1.vr.im.SeedNLSJac40
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_240(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[17] /* $res18.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_VAR */ = (data->localData[0]->realVars[20] /* $cse1 variable */) * (jacobian->tmpVars[16] /* gENCLS.vq.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */) + ((-data->localData[0]->realVars[21] /* $cse2 variable */)) * (jacobian->tmpVars[15] /* gENCLS.vd.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac40 SEED_VAR */;
  TRACE_POP
}
...
equation index: 241
type: SIMPLE_ASSIGN
$res19.$pDERNLSJac40.dummyVarNLSJac40 = $cse2 * gENCLS.vq.$pDERNLSJac40.dummyVarNLSJac40 + $cse1 * gENCLS.vd.$pDERNLSJac40.dummyVarNLSJac40 - pwLine1.vr.re.SeedNLSJac40
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_241(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[18] /* $res19.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_VAR */ = (data->localData[0]->realVars[21] /* $cse2 variable */) * (jacobian->tmpVars[16] /* gENCLS.vq.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */) + (data->localData[0]->realVars[20] /* $cse1 variable */) * (jacobian->tmpVars[15] /* gENCLS.vd.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac40 SEED_VAR */;
  TRACE_POP
}
...
equation index: 243
type: SIMPLE_ASSIGN
$res21.$pDERNLSJac40.dummyVarNLSJac40 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.ir.im.$pDERNLSJac40.dummyVarNLSJac40 else pwLine1.vr.im.SeedNLSJac40 - pwLine1.vs.im.SeedNLSJac40 - (pwLine1.Z.re * (pwLine1.ir.im.$pDERNLSJac40.dummyVarNLSJac40 + (-pwLine1.vr.re.SeedNLSJac40) * pwLine1.Y.im - pwLine1.vr.im.SeedNLSJac40 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.ir.re.$pDERNLSJac40.dummyVarNLSJac40 + pwLine1.vr.im.SeedNLSJac40 * pwLine1.Y.im - pwLine1.vr.re.SeedNLSJac40 * pwLine1.Y.re))
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_244(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[21] /* $res22.$pDERNLSJac40.dummyVarNLSJac40 JACOBIAN_VAR */ = ((tmp109 && tmp110)?jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac40 SEED_VAR */:jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac40 SEED_VAR */ - jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac40 SEED_VAR */ - ((data->simulationInfo->realParameter[236] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac40 SEED_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac40 SEED_VAR */)) * (data->simulationInfo->realParameter[233] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac40 SEED_VAR */) * (data->simulationInfo->realParameter[234] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[235] /* pwLine4.Z.im PARAM */) * (jacobian->seedVars[11] /* pwLine4.ir.re.SeedNLSJac40 SEED_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac40 SEED_VAR */) * (data->simulationInfo->realParameter[233] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac40 SEED_VAR */) * (data->simulationInfo->realParameter[234] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
