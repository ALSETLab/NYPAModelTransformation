...
equation index: 140
type: SIMPLE_ASSIGN
sEXS._EFD0 = gENROE.efd0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_140(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,140};
  data->localData[0]->realVars[125] /* sEXS.EFD0 variable */ = data->simulationInfo->realParameter[171];
  TRACE_POP
}
/*
equation index: 141
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_143(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[67] /* gENROE.PSIppd variable */ = (data->localData[0]->realVars[3] /* gENROE.Epq STATE(1) */) * (data->simulationInfo->realParameter[121]) + (data->localData[0]->realVars[4] /* gENROE.PSIkd STATE(1) */) * (data->simulationInfo->realParameter[123]);
  TRACE_POP
}
/*
equation index: 144
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_144(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[68] /* gENROE.PSIppq variable */ = (data->localData[0]->realVars[5] /* gENROE.PSIkq STATE(1) */) * (data->simulationInfo->realParameter[124]) + (data->localData[0]->realVars[2] /* gENROE.Epd STATE(1) */) * (data->simulationInfo->realParameter[122]);
  TRACE_POP
}
/*
equation index: 145
...
equation index: 146
type: SIMPLE_ASSIGN
$cse5 = OpenIPSL.NonElectrical.Functions.SE(gENROE.PSIpp, gENROE.S10, gENROE.S12, 1.0, 1.2)
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_146(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,146};
  data->localData[0]->realVars[23] /* $cse5 variable */ = omc_OpenIPSL_NonElectrical_Functions_SE(threadData, data->localData[0]->realVars[66] /* gENROE.PSIpp variable */, data->simulationInfo->realParameter[141], data->simulationInfo->realParameter[142], 1.0, 1.2);
  TRACE_POP
}
/*
equation index: 147
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_147(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[16] /* der(gENROE.delta) STATE_DER */ = (data->simulationInfo->realParameter[185]) * (data->localData[0]->realVars[7] /* gENROE.w STATE(1) */);
  TRACE_POP
}
/*
equation index: 148
type: SIMPLE_ASSIGN
sEXS._leadLag._TF._x[1] = sEXS.leadLag.TF.x_scaled[1] / sEXS.leadLag.TF.a_end
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_148(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,148};
  data->localData[0]->realVars[127] /* sEXS.leadLag.TF.x[1] variable */ = DIVISION_SIM(data->localData[0]->realVars[8] /* sEXS.leadLag.TF.x_scaled[1] STATE(1) */,data->simulationInfo->realParameter[257],"sEXS.leadLag.TF.a_end",equationIndexes);
  TRACE_POP
}
/*
equation index: 149
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_149(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[25] /* $cse7 variable */ = cos(data->localData[0]->realVars[6] /* gENROE.delta STATE(1) */);
  TRACE_POP
}
/*
equation index: 150
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_150(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[24] /* $cse6 variable */ = sin(data->localData[0]->realVars[6] /* gENROE.delta STATE(1) */);
  TRACE_POP
}
/*
equation index: 151
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_153(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_154(DATA*, threadData_t*);
...
vars: {pwLine1._is._re, pwLine._ir._re, pwLine1._is._im, constantLoad._p._ii, constantLoad._p._ir, pwLine3._ir._im, pwLine4._is._im, pwLine3._ir._re, pwLine4._is._re, pwLine3._is._im, pwLine4._ir._im, pwLine4._ir._re, gENCLS._id, gENCLS._iq, pwLine1._vr._re, pwLine1._vr._im, gENROE._iq, gENROE._id, pwLine1._vs._im, pwLine1._vs._re, pwLine3._vr._im, pwLine3._vr._re}
eqns: {153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 197, 196, 195, 194, 193, 192, 191, 190, 189, 188, 187, 186, 185, 184, 183, 182, 181, 180, 179, 178, 177, 176}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_243(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[16] = data->localData[0]->realVars[77] /* gENROE.iq variable */;
  data->simulationInfo->nonlinearSystemData[1].nlsxOld[17] = data->localData[0]->realVars[76] /* gENROE.id variable */;
  ...
  data->localData[0]->realVars[77] /* gENROE.iq variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[16];
  data->localData[0]->realVars[76] /* gENROE.id variable */ = data->simulationInfo->nonlinearSystemData[1].nlsx[17];
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_244(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_248(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[114] /* pwLine4.P12 variable */ = ((data->localData[0]->realVars[113] /* pwLine3.vr.re variable */) * (data->localData[0]->realVars[121] /* pwLine4.is.re variable */) + (data->localData[0]->realVars[112] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[120] /* pwLine4.is.im variable */)) * (data->simulationInfo->realParameter[226]);
  TRACE_POP
}
/*
equation index: 249
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_249(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[116] /* pwLine4.Q12 variable */ = ((data->localData[0]->realVars[112] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[121] /* pwLine4.is.re variable */) - ((data->localData[0]->realVars[113] /* pwLine3.vr.re variable */) * (data->localData[0]->realVars[120] /* pwLine4.is.im variable */))) * (data->simulationInfo->realParameter[226]);
  TRACE_POP
}
/*
equation index: 250
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_250(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* pwLine3.P21 variable */ = (((-data->localData[0]->realVars[113] /* pwLine3.vr.re variable */)) * (data->localData[0]->realVars[109] /* pwLine3.ir.re variable */) - ((data->localData[0]->realVars[112] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[108] /* pwLine3.ir.im variable */))) * (data->simulationInfo->realParameter[215]);
  TRACE_POP
}
/*
equation index: 251
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_251(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[107] /* pwLine3.Q21 variable */ = ((data->localData[0]->realVars[113] /* pwLine3.vr.re variable */) * (data->localData[0]->realVars[108] /* pwLine3.ir.im variable */) - ((data->localData[0]->realVars[112] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[109] /* pwLine3.ir.re variable */))) * (data->simulationInfo->realParameter[215]);
  TRACE_POP
}
/*
equation index: 252
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_252(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[62] /* gENROE.I variable */ = sqrt((tmp2 * tmp2) + (tmp3 * tmp3));
  TRACE_POP
}
/*
equation index: 253
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_253(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[74] /* gENROE.anglei variable */ = atan2((-data->localData[0]->realVars[88] /* pwLine.is.im variable */), (-data->localData[0]->realVars[89] /* pwLine.is.re variable */));
  TRACE_POP
}
/*
equation index: 254
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_256(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[12] /* der(gENROE.Epd) STATE_DER */ = DIVISION_SIM((-data->localData[0]->realVars[73] /* gENROE.XaqIlq variable */),data->simulationInfo->realParameter[147],"gENROE.Tpq0",equationIndexes);
  TRACE_POP
}
/*
equation index: 257
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_257(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[14] /* der(gENROE.PSIkd) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[3] /* gENROE.Epq STATE(1) */ + (data->simulationInfo->realParameter[152] - data->simulationInfo->realParameter[153]) * (data->localData[0]->realVars[76] /* gENROE.id variable */) - data->localData[0]->realVars[4] /* gENROE.PSIkd STATE(1) */,data->simulationInfo->realParameter[145],"gENROE.Tppd0",equationIndexes);
  TRACE_POP
}
/*
equation index: 258
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_258(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[72] /* gENROE.XADIFD variable */ = (data->simulationInfo->realParameter[117]) * (data->localData[0]->realVars[3] /* gENROE.Epq STATE(1) */ + (data->simulationInfo->realParameter[152] - data->simulationInfo->realParameter[153]) * (data->localData[0]->realVars[76] /* gENROE.id variable */) - data->localData[0]->realVars[4] /* gENROE.PSIkd STATE(1) */) + data->localData[0]->realVars[3] /* gENROE.Epq STATE(1) */ + (data->localData[0]->realVars[76] /* gENROE.id variable */) * (data->simulationInfo->realParameter[151] - data->simulationInfo->realParameter[153]) + (data->localData[0]->realVars[23] /* $cse5 variable */) * (data->localData[0]->realVars[67] /* gENROE.PSIppd variable */);
  TRACE_POP
}
/*
equation index: 259
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_259(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[71] /* gENROE.Te variable */ = (data->localData[0]->realVars[65] /* gENROE.PSId variable */) * (data->localData[0]->realVars[77] /* gENROE.iq variable */) - ((data->localData[0]->realVars[69] /* gENROE.PSIq variable */) * (data->localData[0]->realVars[76] /* gENROE.id variable */));
  TRACE_POP
}
/*
equation index: 260
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_260(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[17] /* der(gENROE.w) STATE_DER */ = (0.5) * (DIVISION_SIM(DIVISION_SIM(data->simulationInfo->realParameter[178] - ((data->simulationInfo->realParameter[105]) * (data->localData[0]->realVars[7] /* gENROE.w STATE(1) */)),1.0 + data->localData[0]->realVars[7] /* gENROE.w STATE(1) */,"1.0 + gENROE.w",equationIndexes) - data->localData[0]->realVars[71] /* gENROE.Te variable */,data->simulationInfo->realParameter[110],"gENROE.H",equationIndexes));
  TRACE_POP
}
/*
equation index: 261
type: SIMPLE_ASSIGN
sEXS._ECOMP = sqrt(pwLine.vs.re ^ 2.0 + pwLine.vs.im ^ 2.0)
*/
...
equation index: 262
type: SIMPLE_ASSIGN
sEXS._DiffV._y = sEXS.DiffV.k1 * sEXS.VoltageReference.k + sEXS.DiffV.k2 * sEXS.ECOMP
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_262(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,262};
  data->localData[0]->realVars[122] /* sEXS.DiffV.y variable */ = (data->simulationInfo->realParameter[234]) * (data->simulationInfo->realParameter[250]) + (data->simulationInfo->realParameter[235]) * (data->localData[0]->realVars[124] /* sEXS.ECOMP variable */);
  TRACE_POP
}
/*
equation index: 263
type: SIMPLE_ASSIGN
sEXS._V_erro._y = sEXS.V_erro.k1 * const.k + sEXS.V_erro.k2 * sEXS.DiffV.y + sEXS.V_erro.k3 * sEXS.DiffV1.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_263(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,263};
  data->localData[0]->realVars[126] /* sEXS.V_erro.y variable */ = (data->simulationInfo->realParameter[247]) * (data->simulationInfo->realParameter[34]) + (data->simulationInfo->realParameter[248]) * (data->localData[0]->realVars[122] /* sEXS.DiffV.y variable */) + (data->simulationInfo->realParameter[249]) * (data->localData[0]->realVars[123] /* sEXS.DiffV1.y variable */);
  TRACE_POP
}
/*
equation index: 264
type: SIMPLE_ASSIGN
der(sEXS._leadLag._TF._x_scaled[1]) = (sEXS.leadLag.TF.a_end * sEXS.V_erro.y - sEXS.leadLag.TF.a[2] * sEXS.leadLag.TF.x_scaled[1]) / sEXS.leadLag.TF.a[1]
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_264(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,264};
  data->localData[0]->realVars[18] /* der(sEXS.leadLag.TF.x_scaled[1]) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[257]) * (data->localData[0]->realVars[126] /* sEXS.V_erro.y variable */) - ((data->simulationInfo->realParameter[256]) * (data->localData[0]->realVars[8] /* sEXS.leadLag.TF.x_scaled[1] STATE(1) */)),data->simulationInfo->realParameter[255],"sEXS.leadLag.TF.a[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 265
type: SIMPLE_ASSIGN
sEXS._leadLag._TF._y = (sEXS.leadLag.TF.bb[2] - sEXS.leadLag.TF.a[2] * sEXS.leadLag.TF.d) * sEXS.leadLag.TF.x[1] + sEXS.leadLag.TF.d * sEXS.V_erro.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_265(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,265};
  data->localData[0]->realVars[128] /* sEXS.leadLag.TF.y variable */ = (data->simulationInfo->realParameter[261] - ((data->simulationInfo->realParameter[256]) * (data->simulationInfo->realParameter[262]))) * (data->localData[0]->realVars[127] /* sEXS.leadLag.TF.x[1] variable */) + (data->simulationInfo->realParameter[262]) * (data->localData[0]->realVars[126] /* sEXS.V_erro.y variable */);
  TRACE_POP
}
/*
equation index: 266
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_266(DATA *data, threadData_t *threadData)
{
  ...
  tmp6 = Less(fabs(data->simulationInfo->realParameter[252] - data->simulationInfo->realParameter[253]),1e-15);
  data->localData[0]->realVars[129] /* sEXS.leadLag.y variable */ = (tmp6?(data->simulationInfo->realParameter[251]) * (data->localData[0]->realVars[126] /* sEXS.V_erro.y variable */):data->localData[0]->realVars[128] /* sEXS.leadLag.TF.y variable */);
  TRACE_POP
}
/*
equation index: 267
type: SIMPLE_ASSIGN
der(sEXS._simpleLagLim._state) = (sEXS.simpleLagLim.K * sEXS.leadLag.y - sEXS.simpleLagLim.state) / sEXS.simpleLagLim.T_mod
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_267(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,267};
  data->localData[0]->realVars[19] /* der(sEXS.simpleLagLim.state) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[267]) * (data->localData[0]->realVars[129] /* sEXS.leadLag.y variable */) - data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */,data->simulationInfo->realParameter[269],"sEXS.simpleLagLim.T_mod",equationIndexes);
  TRACE_POP
}
/*
equation index: 268
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_268(DATA *data, threadData_t *threadData)
{
  ...
  tmp7 = LessEq(fabs(data->simulationInfo->realParameter[268]),1e-15);
...
equation index: 269
type: SIMPLE_ASSIGN
der(gENROE._Epq) = (gENROE.EFD - gENROE.XADIFD) / gENROE.Tpd0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_269(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,269};
  data->localData[0]->realVars[13] /* der(gENROE.Epq) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[61] /* gENROE.EFD variable */ - data->localData[0]->realVars[72] /* gENROE.XADIFD variable */,data->simulationInfo->realParameter[144],"gENROE.Tpd0",equationIndexes);
  TRACE_POP
}
/*
equation index: 270
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_270(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[270], 14, Greater);
  RELATIONHYSTERESIS(tmp9, (data->simulationInfo->realParameter[267]) * (data->localData[0]->realVars[129] /* sEXS.leadLag.y variable */) - data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, 0.0, 15, Less);
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_271(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[271], 16, Less);
  RELATIONHYSTERESIS(tmp11, (data->simulationInfo->realParameter[267]) * (data->localData[0]->realVars[129] /* sEXS.leadLag.y variable */) - data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */, 0.0, 17, Greater);
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_273(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[75] /* gENROE.anglev variable */ = atan2(data->localData[0]->realVars[90] /* pwLine.vs.im variable */, data->localData[0]->realVars[91] /* pwLine.vs.re variable */);
  TRACE_POP
}
/*
equation index: 274
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_274(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[31] /* GEN1.angle variable */ = (57.29577951308232) * (data->localData[0]->realVars[75] /* gENROE.anglev variable */);
  TRACE_POP
}
/*
equation index: 275
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_275(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[63] /* gENROE.P variable */ = (data->localData[0]->realVars[90] /* pwLine.vs.im variable */) * (data->localData[0]->realVars[88] /* pwLine.is.im variable */) + (data->localData[0]->realVars[91] /* pwLine.vs.re variable */) * (data->localData[0]->realVars[89] /* pwLine.is.re variable */);
  TRACE_POP
}
/*
equation index: 276
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_276(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[64] /* gENROE.PELEC variable */ = DIVISION_SIM(data->localData[0]->realVars[63] /* gENROE.P variable */,data->simulationInfo->realParameter[104],"gENROE.CoB",equationIndexes);
  TRACE_POP
}
/*
equation index: 277
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[70] /* gENROE.Q variable */ = (data->localData[0]->realVars[90] /* pwLine.vs.im variable */) * (data->localData[0]->realVars[89] /* pwLine.is.re variable */) - ((data->localData[0]->realVars[91] /* pwLine.vs.re variable */) * (data->localData[0]->realVars[88] /* pwLine.is.im variable */));
  TRACE_POP
}
/*
equation index: 278
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_278(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[84] /* pwLine.Q12 variable */ = ((data->localData[0]->realVars[90] /* pwLine.vs.im variable */) * (data->localData[0]->realVars[89] /* pwLine.is.re variable */) - ((data->localData[0]->realVars[91] /* pwLine.vs.re variable */) * (data->localData[0]->realVars[88] /* pwLine.is.im variable */))) * (data->simulationInfo->realParameter[193]);
  TRACE_POP
}
/*
equation index: 279
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_279(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[82] /* pwLine.P12 variable */ = ((data->localData[0]->realVars[91] /* pwLine.vs.re variable */) * (data->localData[0]->realVars[89] /* pwLine.is.re variable */) + (data->localData[0]->realVars[90] /* pwLine.vs.im variable */) * (data->localData[0]->realVars[88] /* pwLine.is.im variable */)) * (data->simulationInfo->realParameter[193]);
  TRACE_POP
}
/*
equation index: 280
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_282(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[85] /* pwLine.Q21 variable */ = ((data->localData[0]->realVars[103] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[86] /* pwLine.ir.im variable */) - ((data->localData[0]->realVars[102] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[87] /* pwLine.ir.re variable */))) * (data->simulationInfo->realParameter[193]);
  TRACE_POP
}
/*
equation index: 283
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_283(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[83] /* pwLine.P21 variable */ = (((-data->localData[0]->realVars[103] /* pwLine1.vs.re variable */)) * (data->localData[0]->realVars[87] /* pwLine.ir.re variable */) - ((data->localData[0]->realVars[102] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[86] /* pwLine.ir.im variable */))) * (data->simulationInfo->realParameter[193]);
  TRACE_POP
}
/*
equation index: 284
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_284(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* pwLine3.P12 variable */ = ((data->localData[0]->realVars[103] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[111] /* pwLine3.is.re variable */) + (data->localData[0]->realVars[102] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[110] /* pwLine3.is.im variable */)) * (data->simulationInfo->realParameter[215]);
  TRACE_POP
}
/*
equation index: 285
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_285(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[106] /* pwLine3.Q12 variable */ = ((data->localData[0]->realVars[102] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[111] /* pwLine3.is.re variable */) - ((data->localData[0]->realVars[103] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[110] /* pwLine3.is.im variable */))) * (data->simulationInfo->realParameter[215]);
  TRACE_POP
}
/*
equation index: 286
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_286(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[92] /* pwLine1.P12 variable */ = ((data->localData[0]->realVars[103] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[99] /* pwLine1.is.re variable */) + (data->localData[0]->realVars[102] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[98] /* pwLine1.is.im variable */)) * (data->simulationInfo->realParameter[204]);
  TRACE_POP
}
/*
equation index: 287
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_287(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[94] /* pwLine1.Q12 variable */ = ((data->localData[0]->realVars[102] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[99] /* pwLine1.is.re variable */) - ((data->localData[0]->realVars[103] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[98] /* pwLine1.is.im variable */))) * (data->simulationInfo->realParameter[204]);
  TRACE_POP
}
/*
equation index: 288
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_292(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[93] /* pwLine1.P21 variable */ = (((-data->localData[0]->realVars[101] /* pwLine1.vr.re variable */)) * (data->localData[0]->realVars[97] /* pwLine1.ir.re variable */) - ((data->localData[0]->realVars[100] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[96] /* pwLine1.ir.im variable */))) * (data->simulationInfo->realParameter[204]);
  TRACE_POP
}
/*
equation index: 293
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_293(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[95] /* pwLine1.Q21 variable */ = ((data->localData[0]->realVars[101] /* pwLine1.vr.re variable */) * (data->localData[0]->realVars[96] /* pwLine1.ir.im variable */) - ((data->localData[0]->realVars[100] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[97] /* pwLine1.ir.re variable */))) * (data->simulationInfo->realParameter[204]);
  TRACE_POP
}
/*
equation index: 294
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_294(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[115] /* pwLine4.P21 variable */ = (((-data->localData[0]->realVars[101] /* pwLine1.vr.re variable */)) * (data->localData[0]->realVars[119] /* pwLine4.ir.re variable */) - ((data->localData[0]->realVars[100] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[118] /* pwLine4.ir.im variable */))) * (data->simulationInfo->realParameter[226]);
  TRACE_POP
}
/*
equation index: 295
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_295(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[117] /* pwLine4.Q21 variable */ = ((data->localData[0]->realVars[101] /* pwLine1.vr.re variable */) * (data->localData[0]->realVars[118] /* pwLine4.ir.im variable */) - ((data->localData[0]->realVars[100] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[119] /* pwLine4.ir.re variable */))) * (data->simulationInfo->realParameter[226]);
  TRACE_POP
}
/*
equation index: 296
...
when {$whenCondition2} then
  reinit(sEXS._simpleLagLim._state,  sEXS.simpleLagLim.outMax);
end when;
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_eqFunction_298(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[270];
  ...
  {
    data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[271];
    infoStreamPrint(LOG_EVENTS, 0, "reinit sEXS.simpleLagLim.state = %g", data->localData[0]->realVars[9] /* sEXS.simpleLagLim.state STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void OpenIPSL_Examples_Controls_PSSE_ES_SEXS_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{23e8f484-f6ca-478f-9117-07481040407a}";
  ...
  data->modelData->nParametersReal = 273;
  ...
  data->modelData->modelDataXml.nEquations = 523;
