...
{
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461 tmp1;
  tmp1._S_b = omc_S_b;
  tmp1._fn = omc_fn;
  return tmp1;
}
...
{
  return mmc_mk_box3(3, &OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461__desc, _S_b, _fn);
}
