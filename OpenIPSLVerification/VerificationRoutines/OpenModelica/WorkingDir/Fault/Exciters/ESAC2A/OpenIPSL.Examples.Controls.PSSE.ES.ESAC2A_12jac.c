...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC2A_eqFunction_852(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp45)
  {
    ...
    else
    {
      ...
      tmp27 = (tmp21) * ((data->simulationInfo->realParameter[68] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */));
    }
    ...
    else
    {
      ...
      tmp37 = (tmp31) * ((-1.0 + data->simulationInfo->realParameter[68] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */));
    }
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC2A_eqFunction_875(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp67)
  {
    tmp68 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp65)
    {
      tmp66 = jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac7 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp63)
      {
        ...
        tmp64 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[313] /* pwFault.R PARAM */) * (jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac7 SEED_VAR */) + (data->simulationInfo->realParameter[314] /* pwFault.X PARAM */) * (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac7 SEED_VAR */)) * ((tmp58 * tmp58) + (tmp59 * tmp59)),(tmp62 * tmp62),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp64 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */;
      }
      tmp66 = tmp64;
    }
    tmp68 = tmp66;
  }
  jacobian->resultVars[2] /* $res3.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_VAR */ = tmp68;
  TRACE_POP
}
...
equation index: 882
type: SIMPLE_ASSIGN
$res10.$pDERNLSJac7.dummyVarNLSJac7 = pwLine1.vs.im * constantLoad.p.ii.$pDERNLSJac7.dummyVarNLSJac7 + pwLine1.vs.im.SeedNLSJac7 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.$pDERNLSJac7.dummyVarNLSJac7 + pwLine1.vs.re.SeedNLSJac7 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac7.dummyVarNLSJac7
*/
...
equation index: 883
type: SIMPLE_ASSIGN
$res11.$pDERNLSJac7.dummyVarNLSJac7 = pwLine1.vs.im * constantLoad.p.ir.$pDERNLSJac7.dummyVarNLSJac7 + pwLine1.vs.im.SeedNLSJac7 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac7) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac7.dummyVarNLSJac7 - pwLine1.vs.re * constantLoad.p.ii.$pDERNLSJac7.dummyVarNLSJac7
*/
...
equation index: 887
type: SIMPLE_ASSIGN
$res15.$pDERNLSJac7.dummyVarNLSJac7 = $cse1 * gENCLS.vq.$pDERNLSJac7.dummyVarNLSJac7 + (-$cse2) * gENCLS.vd.$pDERNLSJac7.dummyVarNLSJac7 - pwLine1.vr.im.SeedNLSJac7
*/
...
equation index: 888
type: SIMPLE_ASSIGN
$res16.$pDERNLSJac7.dummyVarNLSJac7 = $cse2 * gENCLS.vq.$pDERNLSJac7.dummyVarNLSJac7 + $cse1 * gENCLS.vd.$pDERNLSJac7.dummyVarNLSJac7 - pwLine1.vr.re.SeedNLSJac7
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC2A_eqFunction_890(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[17] /* $res18.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_VAR */ = ((tmp89 && tmp90)?jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac7 SEED_VAR */:jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac7 SEED_VAR */ - jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac7 SEED_VAR */ - ((data->simulationInfo->realParameter[358] /* pwLine4.Z.re PARAM */) * (jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac7 SEED_VAR */ + ((-jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac7 SEED_VAR */)) * (data->simulationInfo->realParameter[355] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac7 SEED_VAR */) * (data->simulationInfo->realParameter[356] /* pwLine4.Y.re PARAM */))) + (data->simulationInfo->realParameter[357] /* pwLine4.Z.im PARAM */) * (jacobian->tmpVars[17] /* pwLine4.ir.re.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac7 SEED_VAR */) * (data->simulationInfo->realParameter[355] /* pwLine4.Y.im PARAM */) - ((jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac7 SEED_VAR */) * (data->simulationInfo->realParameter[356] /* pwLine4.Y.re PARAM */)))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC2A_eqFunction_891(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp103)
  {
    tmp104 = jacobian->tmpVars[21] /* pwFault.p.ii.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp101)
    {
      tmp102 = jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac7 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp99)
      {
        ...
        tmp100 = jacobian->tmpVars[21] /* pwFault.p.ii.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[313] /* pwFault.R PARAM */) * (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac7 SEED_VAR */) - ((data->simulationInfo->realParameter[314] /* pwFault.X PARAM */) * (jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac7 SEED_VAR */))) * ((tmp94 * tmp94) + (tmp95 * tmp95)),(tmp98 * tmp98),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp100 = jacobian->tmpVars[21] /* pwFault.p.ii.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_DIFF_VAR */;
      }
      tmp102 = tmp100;
    }
    tmp104 = tmp102;
  }
  jacobian->resultVars[18] /* $res19.$pDERNLSJac7.dummyVarNLSJac7 JACOBIAN_VAR */ = tmp104;
  TRACE_POP
}
