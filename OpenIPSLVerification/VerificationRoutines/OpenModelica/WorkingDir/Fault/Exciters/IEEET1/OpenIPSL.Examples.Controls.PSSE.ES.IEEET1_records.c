/* Additional record code for OpenIPSL.Examples.Controls.PSSE.ES.IEEET1 generated by the OpenModelica Compiler OpenModelica 1.16.0~dev-369-gf7aa93e. */
...
#define OpenIPSL_Electrical_D_SystemBase24SysData__desc_added 1
const char* OpenIPSL_Electrical_D_SystemBase24SysData__desc__fields[2] = {"S_b","fn"};
struct record_description OpenIPSL_Electrical_D_SystemBase24SysData__desc = {
  "OpenIPSL_Electrical_D_SystemBase24SysData", /* package_record__X */
  "OpenIPSL.Electrical.SystemBase$SysData", /* package.record_X */
  OpenIPSL_Electrical_D_SystemBase24SysData__desc__fields
};

void OpenIPSL_Electrical_D_SystemBase24SysData_construct_p(threadData_t *threadData, void* v_ths ) {
  OpenIPSL_Electrical_D_SystemBase24SysData* ths = (OpenIPSL_Electrical_D_SystemBase24SysData*)(v_ths);
  ths->_S_b = 100000000.0;
  ths->_fn = 50.0;
}
/*
OpenIPSL_Electrical_D_SystemBase24SysData omc_OpenIPSL_Electrical_D_SystemBase24SysData(threadData_t *threadData , modelica_real in_S_b, modelica_real in_fn) {
  OpenIPSL_Electrical_D_SystemBase24SysData dst;
  // TODO Improve me. No need to initalize the record memebers with defaults in OpenIPSL_Electrical_D_SystemBase24SysData_construct
  // We should just do the allocs here and then copy the input parameters as default values instead.
  OpenIPSL_Electrical_D_SystemBase24SysData_construct(threadData, dst);
  dst._S_b =  in_S_b;
  dst._fn =  in_fn;
  return dst;
}
...
void OpenIPSL_Electrical_D_SystemBase24SysData_copy_p(void* v_src, void* v_dst) {
  OpenIPSL_Electrical_D_SystemBase24SysData* src = (OpenIPSL_Electrical_D_SystemBase24SysData*)(v_src);
  OpenIPSL_Electrical_D_SystemBase24SysData* dst = (OpenIPSL_Electrical_D_SystemBase24SysData*)(v_dst);
  dst->_S_b = src->_S_b;
  dst->_fn = src->_fn;
}
