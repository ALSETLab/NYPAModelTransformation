...
equation index: 764
type: SIMPLE_ASSIGN
_omcQuot_2463736535 = OpenIPSL.NonElectrical.Functions.SE_exp(gENROE.PSIpp, gENROE.S10, gENROE.S12, 1.0, 1.2)
*/
...
equation index: 770
type: SIMPLE_ASSIGN
_omcQuot_2463736537 = cos(gENROE.delta)
*/
...
equation index: 771
type: SIMPLE_ASSIGN
_omcQuot_2463736536 = sin(gENROE.delta)
*/
...
equation index: 908
type: SIMPLE_ASSIGN
_omcQuot_247768656E436F6E646974696F6E32 = eSAC1A.simpleLagLim.state > eSAC1A.simpleLagLim.outMax and eSAC1A.simpleLagLim.K * eSAC1A.imLeadLag.y - eSAC1A.simpleLagLim.state < 0.0
*/
...
equation index: 909
type: SIMPLE_ASSIGN
_omcQuot_247768656E436F6E646974696F6E31 = eSAC1A.simpleLagLim.state < eSAC1A.simpleLagLim.outMin and eSAC1A.simpleLagLim.K * eSAC1A.imLeadLag.y - eSAC1A.simpleLagLim.state > 0.0
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{72fd0c8f-6673-4dda-839c-0260480b2615}";
