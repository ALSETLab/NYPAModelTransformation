...
equation index: 611
type: SIMPLE_ASSIGN
_omcQuot_245354415254._eSAC1A._rotatingExciterWithDemagnetization._sISO._y = eSAC1A.rotatingExciterWithDemagnetization.sISO.y_start
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_initialNonLinearSystem(int nNonLinearSystems, NONLINEAR_SYSTEM_DATA* nonLinearSystemData)
{
  ...
  nonLinearSystemData[4].analyticalJacobianColumn = OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_functionJacNLSJac8_column;
  nonLinearSystemData[4].initialAnalyticalJacobian = OpenIPSL_Examples_Controls_PSSE_ES_ESAC1A_initialAnalyticJacobianNLSJac8;
