/* Additional record code for OpenIPSL.Examples.Controls.PSSE.ES.ESAC1A generated by the OpenModelica Compiler OpenModelica 1.15.0~dev-49-gb315f0e. */
...
#define OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461__desc_added 1
const char* OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461__desc__fields[2] = {"S_b","fn"};
struct record_description OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461__desc = {
  "OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461", /* package_record__X */
  "OpenIPSL.Electrical.SystemBase$SysData", /* package.record_X */
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461__desc__fields
};

void OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461_construct_p(threadData_t *threadData, void* v_ths ) {
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461* ths = (OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461*)(v_ths);
  ths->_S_b = 100000000.0;
  ths->_fn = 50.0;
}
/*
OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461 omc_OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461(threadData_t *threadData , modelica_real in_S_b, modelica_real in_fn) {
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461 dst;
  // TODO Improve me. No need to initalize the record memebers with defaults in OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461_construct
  // We should just do the allocs here and then copy the input parameters as default values instead.
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461_construct(threadData, dst);
  dst._S_b =  in_S_b;
  dst._fn =  in_fn;
  return dst;
}
...
void OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461_copy_p(void* v_src, void* v_dst) {
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461* src = (OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461*)(v_src);
  OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461* dst = (OpenIPSL_Electrical__omcQuot_53797374656D426173652453797344617461*)(v_dst);
  dst->_S_b = src->_S_b;
  dst->_fn = src->_fn;
}
