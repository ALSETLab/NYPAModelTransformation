...
const char *OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs20[] = {1,296};
  static const int occurEqs21[] = {1,300};
  static const int occurEqs22[] = {1,301};
  static const int occurEqs23[] = {1,302};
...
int OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  tmp0 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[278], data->simulationInfo->storedRelations[0]);
  tmp1 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[279], data->simulationInfo->storedRelations[1]);
  gout[0] = ((tmp0 && tmp1)) ? 1 : -1;
  tmp2 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[278], data->simulationInfo->storedRelations[0]);
  gout[1] = (tmp2) ? 1 : -1;
  tmp3 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[279], data->simulationInfo->storedRelations[1]);
  gout[2] = (tmp3) ? 1 : -1;
  tmp4 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[73], data->simulationInfo->storedRelations[2]);
  tmp5 = LessEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[73] + data->simulationInfo->realParameter[67], data->simulationInfo->storedRelations[3]);
  ...
  gout[4] = (tmp6) ? 1 : -1;
  tmp7 = LessZC(data->localData[0]->realVars[55] /* constantLoad.v variable */, data->simulationInfo->realParameter[37], data->simulationInfo->storedRelations[5]);
  gout[5] = (tmp7) ? 1 : -1;
  tmp8 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[73], data->simulationInfo->storedRelations[2]);
  gout[6] = (tmp8) ? 1 : -1;
  tmp9 = LessEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[73] + data->simulationInfo->realParameter[67], data->simulationInfo->storedRelations[3]);
  gout[7] = (tmp9) ? 1 : -1;
  tmp10 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[300], data->simulationInfo->storedRelations[6]);
  tmp11 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[301], data->simulationInfo->storedRelations[7]);
  gout[8] = ((tmp10 && tmp11)) ? 1 : -1;
  tmp12 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[300], data->simulationInfo->storedRelations[6]);
  gout[9] = (tmp12) ? 1 : -1;
  tmp13 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[301], data->simulationInfo->storedRelations[7]);
  gout[10] = (tmp13) ? 1 : -1;
  tmp14 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[267], data->simulationInfo->storedRelations[8]);
  gout[11] = (tmp14) ? 1 : -1;
  tmp15 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[268], data->simulationInfo->storedRelations[9]);
  gout[12] = ((tmp15 && data->simulationInfo->booleanParameter[66])) ? 1 : -1;
  tmp16 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[268], data->simulationInfo->storedRelations[9]);
  gout[13] = (tmp16) ? 1 : -1;
  tmp17 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[311], data->simulationInfo->storedRelations[10]);
  tmp18 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[312], data->simulationInfo->storedRelations[11]);
  gout[14] = ((tmp17 && tmp18)) ? 1 : -1;
  tmp19 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[311], data->simulationInfo->storedRelations[10]);
  gout[15] = (tmp19) ? 1 : -1;
  tmp20 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[312], data->simulationInfo->storedRelations[11]);
  gout[16] = (tmp20) ? 1 : -1;
  tmp21 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[289], data->simulationInfo->storedRelations[12]);
  tmp22 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[290], data->simulationInfo->storedRelations[13]);
  gout[17] = ((tmp21 && tmp22)) ? 1 : -1;
  tmp23 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[289], data->simulationInfo->storedRelations[12]);
  gout[18] = (tmp23) ? 1 : -1;
  tmp24 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[290], data->simulationInfo->storedRelations[13]);
  gout[19] = (tmp24) ? 1 : -1;
  tmp25 = LessZC(data->localData[0]->realVars[63] /* eSDC1A.hV_GATE.n1 variable */, data->simulationInfo->realParameter[35], data->simulationInfo->storedRelations[14]);
  gout[20] = (tmp25) ? 1 : -1;
  tmp26 = LessZC(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[145], data->simulationInfo->storedRelations[15]);
  tmp27 = LessZC((data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, data->simulationInfo->storedRelations[16]);
  tmp28 = GreaterZC(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[144], data->simulationInfo->storedRelations[17]);
  tmp29 = GreaterZC((data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, data->simulationInfo->storedRelations[18]);
  gout[21] = (((tmp26 && tmp27) || (tmp28 && tmp29))) ? 1 : -1;
  tmp30 = GreaterZC(data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[154], data->simulationInfo->storedRelations[19]);
  tmp31 = LessZC((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, data->simulationInfo->storedRelations[20]);
  gout[22] = ((tmp30 && tmp31)) ? 1 : -1;
  tmp32 = LessZC(data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[155], data->simulationInfo->storedRelations[21]);
  tmp33 = GreaterZC((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, data->simulationInfo->storedRelations[22]);
...
int OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    tmp34 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[278], data->simulationInfo->storedRelations[0]);
    data->simulationInfo->relations[0] = tmp34;
    tmp35 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[279], data->simulationInfo->storedRelations[1]);
    data->simulationInfo->relations[1] = tmp35;
    tmp36 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[73], data->simulationInfo->storedRelations[2]);
    data->simulationInfo->relations[2] = tmp36;
    tmp37 = LessEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[73] + data->simulationInfo->realParameter[67], data->simulationInfo->storedRelations[3]);
    ...
    tmp39 = LessZC(data->localData[0]->realVars[55] /* constantLoad.v variable */, data->simulationInfo->realParameter[37], data->simulationInfo->storedRelations[5]);
    data->simulationInfo->relations[5] = tmp39;
    tmp40 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[300], data->simulationInfo->storedRelations[6]);
    data->simulationInfo->relations[6] = tmp40;
    tmp41 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[301], data->simulationInfo->storedRelations[7]);
    data->simulationInfo->relations[7] = tmp41;
    tmp42 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[267], data->simulationInfo->storedRelations[8]);
    data->simulationInfo->relations[8] = tmp42;
    tmp43 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[268], data->simulationInfo->storedRelations[9]);
    data->simulationInfo->relations[9] = tmp43;
    tmp44 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[311], data->simulationInfo->storedRelations[10]);
    data->simulationInfo->relations[10] = tmp44;
    tmp45 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[312], data->simulationInfo->storedRelations[11]);
    data->simulationInfo->relations[11] = tmp45;
    tmp46 = GreaterEqZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[289], data->simulationInfo->storedRelations[12]);
    data->simulationInfo->relations[12] = tmp46;
    tmp47 = LessZC(data->localData[0]->timeValue, data->simulationInfo->realParameter[290], data->simulationInfo->storedRelations[13]);
    data->simulationInfo->relations[13] = tmp47;
    tmp48 = LessZC(data->localData[0]->realVars[63] /* eSDC1A.hV_GATE.n1 variable */, data->simulationInfo->realParameter[35], data->simulationInfo->storedRelations[14]);
    data->simulationInfo->relations[14] = tmp48;
    tmp49 = LessZC(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[145], data->simulationInfo->storedRelations[15]);
    data->simulationInfo->relations[15] = tmp49;
    tmp50 = LessZC((data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, data->simulationInfo->storedRelations[16]);
    data->simulationInfo->relations[16] = tmp50;
    tmp51 = GreaterZC(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[144], data->simulationInfo->storedRelations[17]);
    data->simulationInfo->relations[17] = tmp51;
    tmp52 = GreaterZC((data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, data->simulationInfo->storedRelations[18]);
    data->simulationInfo->relations[18] = tmp52;
    tmp53 = GreaterZC(data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[154], data->simulationInfo->storedRelations[19]);
    data->simulationInfo->relations[19] = tmp53;
    tmp54 = LessZC((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, data->simulationInfo->storedRelations[20]);
    data->simulationInfo->relations[20] = tmp54;
    tmp55 = LessZC(data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[155], data->simulationInfo->storedRelations[21]);
    data->simulationInfo->relations[21] = tmp55;
    tmp56 = GreaterZC((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, data->simulationInfo->storedRelations[22]);
    data->simulationInfo->relations[22] = tmp56;
  } else {
    data->simulationInfo->relations[0] = (data->localData[0]->timeValue >= data->simulationInfo->realParameter[278]);
    data->simulationInfo->relations[1] = (data->localData[0]->timeValue < data->simulationInfo->realParameter[279]);
    ...
    data->simulationInfo->relations[5] = (data->localData[0]->realVars[55] /* constantLoad.v variable */ < data->simulationInfo->realParameter[37]);
    data->simulationInfo->relations[6] = (data->localData[0]->timeValue >= data->simulationInfo->realParameter[300]);
    data->simulationInfo->relations[7] = (data->localData[0]->timeValue < data->simulationInfo->realParameter[301]);
    data->simulationInfo->relations[8] = (data->localData[0]->timeValue < data->simulationInfo->realParameter[267]);
    data->simulationInfo->relations[9] = (data->localData[0]->timeValue < data->simulationInfo->realParameter[268]);
    data->simulationInfo->relations[10] = (data->localData[0]->timeValue >= data->simulationInfo->realParameter[311]);
    data->simulationInfo->relations[11] = (data->localData[0]->timeValue < data->simulationInfo->realParameter[312]);
    data->simulationInfo->relations[12] = (data->localData[0]->timeValue >= data->simulationInfo->realParameter[289]);
    data->simulationInfo->relations[13] = (data->localData[0]->timeValue < data->simulationInfo->realParameter[290]);
    data->simulationInfo->relations[14] = (data->localData[0]->realVars[63] /* eSDC1A.hV_GATE.n1 variable */ < data->simulationInfo->realParameter[35]);
    data->simulationInfo->relations[15] = (data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */ < data->simulationInfo->realParameter[145]);
    data->simulationInfo->relations[16] = ((data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */) < 0.0);
    data->simulationInfo->relations[17] = (data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */ > data->simulationInfo->realParameter[144]);
    data->simulationInfo->relations[18] = ((data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */) > 0.0);
    data->simulationInfo->relations[19] = (data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ > data->simulationInfo->realParameter[154]);
    data->simulationInfo->relations[20] = ((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ < 0.0);
    data->simulationInfo->relations[21] = (data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ < data->simulationInfo->realParameter[155]);
    data->simulationInfo->relations[22] = ((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ > 0.0);
  }
