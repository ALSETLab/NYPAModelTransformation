...
equation index: 165
type: SIMPLE_ASSIGN
eSDC1A._EFD0 = gENROE.efd0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_165(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,165};
  data->localData[0]->realVars[60] /* eSDC1A.EFD0 variable */ = data->simulationInfo->realParameter[250];
  TRACE_POP
}
/*
equation index: 166
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_168(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[90] /* gENROE.PSIppd variable */ = (data->localData[0]->realVars[8] /* gENROE.Epq STATE(1) */) * (data->simulationInfo->realParameter[200]) + (data->localData[0]->realVars[9] /* gENROE.PSIkd STATE(1) */) * (data->simulationInfo->realParameter[202]);
  TRACE_POP
}
/*
equation index: 169
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_169(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[91] /* gENROE.PSIppq variable */ = (data->localData[0]->realVars[10] /* gENROE.PSIkq STATE(1) */) * (data->simulationInfo->realParameter[203]) + (data->localData[0]->realVars[7] /* gENROE.Epd STATE(1) */) * (data->simulationInfo->realParameter[201]);
  TRACE_POP
}
/*
equation index: 170
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_171(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[29] /* $cse5 variable */ = omc_OpenIPSL_NonElectrical_Functions_SE__exp(threadData, data->localData[0]->realVars[89] /* gENROE.PSIpp variable */, data->simulationInfo->realParameter[220], data->simulationInfo->realParameter[221], 1.0, 1.2);
  TRACE_POP
}
/*
equation index: 172
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_172(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[24] /* der(gENROE.delta) STATE_DER */ = (data->simulationInfo->realParameter[264]) * (data->localData[0]->realVars[12] /* gENROE.w STATE(1) */);
  TRACE_POP
}
/*
equation index: 173
type: SIMPLE_ASSIGN
der(eSDC1A._imDerivativeLag._x) = (eSDC1A.rotatingExciterLimited.sISO.y - eSDC1A.imDerivativeLag.x) / eSDC1A.imDerivativeLag.T
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_173(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,173};
  data->localData[0]->realVars[14] /* der(eSDC1A.imDerivativeLag.x) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */ - data->localData[0]->realVars[1] /* eSDC1A.imDerivativeLag.x STATE(1) */,data->simulationInfo->realParameter[113],"eSDC1A.imDerivativeLag.T",equationIndexes);
  TRACE_POP
}
/*
equation index: 174
type: SIMPLE_ASSIGN
eSDC1A._imDerivativeLag._y = 0.07000000000000001 * (eSDC1A.rotatingExciterLimited.sISO.y - eSDC1A.imDerivativeLag.x) / eSDC1A.imDerivativeLag.T
*/
...
equation index: 175
type: SIMPLE_ASSIGN
eSDC1A._imLeadLag._TF._x[1] = eSDC1A.imLeadLag.TF.x_scaled[1] / eSDC1A.imLeadLag.TF.a_end
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_175(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,175};
  data->localData[0]->realVars[66] /* eSDC1A.imLeadLag.TF.x[1] variable */ = DIVISION_SIM(data->localData[0]->realVars[2] /* eSDC1A.imLeadLag.TF.x_scaled[1] STATE(1) */,data->simulationInfo->realParameter[123],"eSDC1A.imLeadLag.TF.a_end",equationIndexes);
  TRACE_POP
}
/*
equation index: 176
type: SIMPLE_ASSIGN
eSDC1A._rotatingExciterLimited._Sum._u2 = eSDC1A.rotatingExciterLimited.gain.k * eSDC1A.rotatingExciterLimited.sISO.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_176(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,176};
  data->localData[0]->realVars[70] /* eSDC1A.rotatingExciterLimited.Sum.u2 variable */ = (data->simulationInfo->realParameter[142]) * (data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */);
  TRACE_POP
}
/*
equation index: 177
type: SIMPLE_ASSIGN
eSDC1A._rotatingExciterLimited._VE._u2 = OpenIPSL.NonElectrical.Functions.SE(eSDC1A.rotatingExciterLimited.sISO.y, eSDC1A.rotatingExciterLimited.se1.SE1, eSDC1A.rotatingExciterLimited.se1.SE2, eSDC1A.rotatingExciterLimited.se1.E1, eSDC1A.rotatingExciterLimited.se1.E2)
*/
...
equation index: 178
type: SIMPLE_ASSIGN
eSDC1A._rotatingExciterLimited._Sum._u1 = eSDC1A.rotatingExciterLimited.sISO.y * eSDC1A.rotatingExciterLimited.VE.u2
*/
...
equation index: 179
type: SIMPLE_ASSIGN
eSDC1A._rotatingExciterLimited._Sum._y = eSDC1A.rotatingExciterLimited.Sum.k1 * eSDC1A.rotatingExciterLimited.Sum.u1 + eSDC1A.rotatingExciterLimited.Sum.k2 * eSDC1A.rotatingExciterLimited.Sum.u2
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_179(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,179};
  data->localData[0]->realVars[71] /* eSDC1A.rotatingExciterLimited.Sum.y variable */ = (data->simulationInfo->realParameter[139]) * (data->localData[0]->realVars[69] /* eSDC1A.rotatingExciterLimited.Sum.u1 variable */) + (data->simulationInfo->realParameter[140]) * (data->localData[0]->realVars[70] /* eSDC1A.rotatingExciterLimited.Sum.u2 variable */);
  TRACE_POP
}
/*
equation index: 180
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_184(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_185(DATA*, threadData_t*);
...
vars: {pwLine3._ir._im, pwLine4._is._im, pwLine4._is._re, pwLine3._ir._re, pwLine1._is._im, pwLine._ir._im, pwLine1._is._re, pwLine._ir._re, constantLoad._p._ii, constantLoad._p._ir, pwLine4._ir._im, pwLine1._ir._re, gENCLS._id, gENCLS._iq, pwLine1._vr._im, pwLine1._vr._re, gENROE._iq, gENROE._id, pwLine1._vs._im, pwLine3._vr._re, pwLine3._vr._im, pwLine1._vs._re}
eqns: {184, 185, 186, 187, 188, 189, 190, 191, 192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204, 205, 206, 228, 227, 226, 225, 224, 223, 222, 221, 220, 219, 218, 217, 216, 215, 214, 213, 212, 211, 210, 209, 208, 207}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_274(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_276(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[95] /* gENROE.XaqIlq variable */ = (data->simulationInfo->realParameter[197]) * (data->localData[0]->realVars[7] /* gENROE.Epd STATE(1) */ + (data->simulationInfo->realParameter[236] - data->simulationInfo->realParameter[231]) * (data->localData[0]->realVars[99] /* gENROE.iq variable */) - data->localData[0]->realVars[10] /* gENROE.PSIkq STATE(1) */) + data->localData[0]->realVars[7] /* gENROE.Epd STATE(1) */ + (data->localData[0]->realVars[99] /* gENROE.iq variable */) * (data->simulationInfo->realParameter[236] - data->simulationInfo->realParameter[237]) + (data->localData[0]->realVars[29] /* $cse5 variable */) * ((data->localData[0]->realVars[91] /* gENROE.PSIppq variable */) * (DIVISION_SIM(data->simulationInfo->realParameter[237] - data->simulationInfo->realParameter[231],data->simulationInfo->realParameter[230] - data->simulationInfo->realParameter[231],"gENROE.Xd - gENROE.Xl",equationIndexes)));
  TRACE_POP
}
/*
equation index: 277
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[20] /* der(gENROE.Epd) STATE_DER */ = DIVISION_SIM((-data->localData[0]->realVars[95] /* gENROE.XaqIlq variable */),data->simulationInfo->realParameter[226],"gENROE.Tpq0",equationIndexes);
  TRACE_POP
}
/*
equation index: 278
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_280(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[25] /* der(gENROE.w) STATE_DER */ = (0.5) * (DIVISION_SIM(DIVISION_SIM(data->simulationInfo->realParameter[257] - ((data->simulationInfo->realParameter[184]) * (data->localData[0]->realVars[12] /* gENROE.w STATE(1) */)),1.0 + data->localData[0]->realVars[12] /* gENROE.w STATE(1) */,"1.0 + gENROE.w",equationIndexes) - data->localData[0]->realVars[94] /* gENROE.Te variable */,data->simulationInfo->realParameter[189],"gENROE.H",equationIndexes));
  TRACE_POP
}
/*
equation index: 281
type: SIMPLE_ASSIGN
eSDC1A._XADIFD = gENROE.K1d * (gENROE.Epq + (gENROE.Xl - gENROE.Xpd) * gENROE.id - gENROE.PSIkd) + gENROE.Epq + gENROE.id * (gENROE.Xd - gENROE.Xpd) + $cse5 * gENROE.PSIppd
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_281(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,281};
  data->localData[0]->realVars[61] /* eSDC1A.XADIFD variable */ = (data->simulationInfo->realParameter[196]) * (data->localData[0]->realVars[8] /* gENROE.Epq STATE(1) */ + (data->simulationInfo->realParameter[231] - data->simulationInfo->realParameter[232]) * (data->localData[0]->realVars[98] /* gENROE.id variable */) - data->localData[0]->realVars[9] /* gENROE.PSIkd STATE(1) */) + data->localData[0]->realVars[8] /* gENROE.Epq STATE(1) */ + (data->localData[0]->realVars[98] /* gENROE.id variable */) * (data->simulationInfo->realParameter[230] - data->simulationInfo->realParameter[232]) + (data->localData[0]->realVars[29] /* $cse5 variable */) * (data->localData[0]->realVars[90] /* gENROE.PSIppd variable */);
  TRACE_POP
}
/*
equation index: 282
type: SIMPLE_ASSIGN
der(gENROE._Epq) = (eSDC1A.rotatingExciterLimited.sISO.y - eSDC1A.XADIFD) / gENROE.Tpd0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_282(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,282};
  data->localData[0]->realVars[21] /* der(gENROE.Epq) STATE_DER */ = DIVISION_SIM(data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */ - data->localData[0]->realVars[61] /* eSDC1A.XADIFD variable */,data->simulationInfo->realParameter[223],"gENROE.Tpd0",equationIndexes);
  TRACE_POP
}
/*
equation index: 283
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_286(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[87] /* gENROE.PELEC variable */ = DIVISION_SIM(data->localData[0]->realVars[86] /* gENROE.P variable */,data->simulationInfo->realParameter[183],"gENROE.CoB",equationIndexes);
  TRACE_POP
}
/*
equation index: 287
...
equation index: 288
type: SIMPLE_ASSIGN
eSDC1A._ECOMP = sqrt(pwLine.vs.re ^ 2.0 + pwLine.vs.im ^ 2.0)
*/
...
equation index: 289
type: SIMPLE_ASSIGN
der(eSDC1A._TransducerDelay._state) = (eSDC1A.TransducerDelay.K * eSDC1A.ECOMP - eSDC1A.TransducerDelay.state) / eSDC1A.TransducerDelay.T_mod
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_289(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,289};
  data->localData[0]->realVars[13] /* der(eSDC1A.TransducerDelay.state) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[99]) * (data->localData[0]->realVars[59] /* eSDC1A.ECOMP variable */) - data->localData[0]->realVars[0] /* eSDC1A.TransducerDelay.state STATE(1) */,data->simulationInfo->realParameter[101],"eSDC1A.TransducerDelay.T_mod",equationIndexes);
  TRACE_POP
}
/*
equation index: 290
type: SIMPLE_ASSIGN
eSDC1A._DiffV._u2 = if abs(eSDC1A.TransducerDelay.T) <= 1e-15 then eSDC1A.ECOMP * eSDC1A.TransducerDelay.K else eSDC1A.TransducerDelay.state
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_290(DATA *data, threadData_t *threadData)
{
  ...
  tmp4 = LessEq(fabs(data->simulationInfo->realParameter[100]),1e-15);
  data->localData[0]->realVars[56] /* eSDC1A.DiffV.u2 variable */ = (tmp4?(data->localData[0]->realVars[59] /* eSDC1A.ECOMP variable */) * (data->simulationInfo->realParameter[99]):data->localData[0]->realVars[0] /* eSDC1A.TransducerDelay.state STATE(1) */);
  TRACE_POP
}
/*
equation index: 291
type: SIMPLE_ASSIGN
eSDC1A._DiffV._y = eSDC1A.DiffV.k1 * eSDC1A.VoltageReference.k + eSDC1A.DiffV.k2 * eSDC1A.DiffV.u2
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_291(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,291};
  data->localData[0]->realVars[57] /* eSDC1A.DiffV.y variable */ = (data->simulationInfo->realParameter[78]) * (data->simulationInfo->realParameter[109]) + (data->simulationInfo->realParameter[79]) * (data->localData[0]->realVars[56] /* eSDC1A.DiffV.u2 variable */);
  TRACE_POP
}
/*
equation index: 292
type: SIMPLE_ASSIGN
eSDC1A._add3_1._y = eSDC1A.add3_1.k1 * eSDC1A.DiffV1.y + eSDC1A.add3_1.k2 * eSDC1A.DiffV.y + eSDC1A.add3_1.k3 * eSDC1A.imDerivativeLag.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_292(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,292};
  data->localData[0]->realVars[62] /* eSDC1A.add3_1.y variable */ = (data->simulationInfo->realParameter[110]) * (data->localData[0]->realVars[58] /* eSDC1A.DiffV1.y variable */) + (data->simulationInfo->realParameter[111]) * (data->localData[0]->realVars[57] /* eSDC1A.DiffV.y variable */) + (data->simulationInfo->realParameter[112]) * (data->localData[0]->realVars[65] /* eSDC1A.imDerivativeLag.y variable */);
  TRACE_POP
}
/*
equation index: 293
type: SIMPLE_ASSIGN
der(eSDC1A._imLeadLag._TF._x_scaled[1]) = (eSDC1A.imLeadLag.TF.a_end * eSDC1A.add3_1.y - eSDC1A.imLeadLag.TF.a[2] * eSDC1A.imLeadLag.TF.x_scaled[1]) / eSDC1A.imLeadLag.TF.a[1]
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_293(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,293};
  data->localData[0]->realVars[15] /* der(eSDC1A.imLeadLag.TF.x_scaled[1]) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[123]) * (data->localData[0]->realVars[62] /* eSDC1A.add3_1.y variable */) - ((data->simulationInfo->realParameter[122]) * (data->localData[0]->realVars[2] /* eSDC1A.imLeadLag.TF.x_scaled[1] STATE(1) */)),data->simulationInfo->realParameter[121],"eSDC1A.imLeadLag.TF.a[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 294
type: SIMPLE_ASSIGN
eSDC1A._imLeadLag._TF._y = (eSDC1A.imLeadLag.TF.bb[2] - eSDC1A.imLeadLag.TF.a[2] * eSDC1A.imLeadLag.TF.d) * eSDC1A.imLeadLag.TF.x[1] + eSDC1A.imLeadLag.TF.d * eSDC1A.add3_1.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_294(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,294};
  data->localData[0]->realVars[67] /* eSDC1A.imLeadLag.TF.y variable */ = (data->simulationInfo->realParameter[127] - ((data->simulationInfo->realParameter[122]) * (data->simulationInfo->realParameter[128]))) * (data->localData[0]->realVars[66] /* eSDC1A.imLeadLag.TF.x[1] variable */) + (data->simulationInfo->realParameter[128]) * (data->localData[0]->realVars[62] /* eSDC1A.add3_1.y variable */);
  TRACE_POP
}
/*
equation index: 295
type: SIMPLE_ASSIGN
eSDC1A._hV_GATE._n1 = if abs(eSDC1A.imLeadLag.T1 - eSDC1A.imLeadLag.T2) < 1e-15 then eSDC1A.imLeadLag.K * eSDC1A.add3_1.y else eSDC1A.imLeadLag.TF.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_295(DATA *data, threadData_t *threadData)
{
  ...
  tmp5 = Less(fabs(data->simulationInfo->realParameter[118] - data->simulationInfo->realParameter[119]),1e-15);
  data->localData[0]->realVars[63] /* eSDC1A.hV_GATE.n1 variable */ = (tmp5?(data->simulationInfo->realParameter[117]) * (data->localData[0]->realVars[62] /* eSDC1A.add3_1.y variable */):data->localData[0]->realVars[67] /* eSDC1A.imLeadLag.TF.y variable */);
  TRACE_POP
}
/*
equation index: 296
type: SIMPLE_ASSIGN
eSDC1A._hV_GATE._p = if eSDC1A.hV_GATE.n1 < const1.k then const1.k else eSDC1A.hV_GATE.n1
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_296(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[63] /* eSDC1A.hV_GATE.n1 variable */, data->simulationInfo->realParameter[35], 14, Less);
  data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */ = (tmp6?data->simulationInfo->realParameter[35]:data->localData[0]->realVars[63] /* eSDC1A.hV_GATE.n1 variable */);
  TRACE_POP
}
/*
equation index: 297
type: SIMPLE_ASSIGN
der(eSDC1A._simpleLagLim._state) = (eSDC1A.simpleLagLim.K * eSDC1A.hV_GATE.p - eSDC1A.simpleLagLim.state) / eSDC1A.simpleLagLim.T_mod
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_297(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,297};
  data->localData[0]->realVars[17] /* der(eSDC1A.simpleLagLim.state) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */,data->simulationInfo->realParameter[153],"eSDC1A.simpleLagLim.T_mod",equationIndexes);
  TRACE_POP
}
/*
equation index: 298
type: SIMPLE_ASSIGN
eSDC1A._rotatingExciterLimited._I_C = if abs(eSDC1A.simpleLagLim.T) <= 1e-15 then max(min(eSDC1A.hV_GATE.p * eSDC1A.simpleLagLim.K, eSDC1A.simpleLagLim.outMax), eSDC1A.simpleLagLim.outMin) else max(min(eSDC1A.simpleLagLim.state, eSDC1A.simpleLagLim.outMax), eSDC1A.simpleLagLim.outMin)
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_298(DATA *data, threadData_t *threadData)
{
  ...
  tmp7 = LessEq(fabs(data->simulationInfo->realParameter[152]),1e-15);
  data->localData[0]->realVars[68] /* eSDC1A.rotatingExciterLimited.I_C variable */ = (tmp7?fmax(fmin((data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) * (data->simulationInfo->realParameter[151]),data->simulationInfo->realParameter[154]),data->simulationInfo->realParameter[155]):fmax(fmin(data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */,data->simulationInfo->realParameter[154]),data->simulationInfo->realParameter[155]));
  TRACE_POP
}
/*
equation index: 299
type: SIMPLE_ASSIGN
eSDC1A._rotatingExciterLimited._feedback._y = eSDC1A.rotatingExciterLimited.I_C - eSDC1A.rotatingExciterLimited.Sum.y
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_300(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[145], 15, Less);
  RELATIONHYSTERESIS(tmp9, (data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, 16, Less);
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[3] /* eSDC1A.rotatingExciterLimited.sISO.y STATE(1) */, data->simulationInfo->realParameter[144], 17, Greater);
  RELATIONHYSTERESIS(tmp11, (data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */), 0.0, 18, Greater);
  data->localData[0]->realVars[16] /* der(eSDC1A.rotatingExciterLimited.sISO.y) STATE_DER */ = (((tmp8 && tmp9) || (tmp10 && tmp11))?0.0:(data->simulationInfo->realParameter[143]) * (data->localData[0]->realVars[73] /* eSDC1A.rotatingExciterLimited.feedback.y variable */));
  TRACE_POP
}
/*
equation index: 301
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_301(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp12, data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[154], 19, Greater);
  RELATIONHYSTERESIS(tmp13, (data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, 20, Less);
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_302(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp14, data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[155], 21, Less);
  RELATIONHYSTERESIS(tmp15, (data->simulationInfo->realParameter[151]) * (data->localData[0]->realVars[64] /* eSDC1A.hV_GATE.p variable */) - data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */, 0.0, 22, Greater);
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_306(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[106] /* pwLine.Q12 variable */ = ((data->localData[0]->realVars[112] /* pwLine.vs.im variable */) * (data->localData[0]->realVars[111] /* pwLine.is.re variable */) - ((data->localData[0]->realVars[113] /* pwLine.vs.re variable */) * (data->localData[0]->realVars[110] /* pwLine.is.im variable */))) * (data->simulationInfo->realParameter[272]);
  TRACE_POP
}
/*
equation index: 307
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_307(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* pwLine.P12 variable */ = ((data->localData[0]->realVars[113] /* pwLine.vs.re variable */) * (data->localData[0]->realVars[111] /* pwLine.is.re variable */) + (data->localData[0]->realVars[112] /* pwLine.vs.im variable */) * (data->localData[0]->realVars[110] /* pwLine.is.im variable */)) * (data->simulationInfo->realParameter[272]);
  TRACE_POP
}
/*
equation index: 308
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_309(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[136] /* pwLine4.P12 variable */ = ((data->localData[0]->realVars[135] /* pwLine3.vr.re variable */) * (data->localData[0]->realVars[143] /* pwLine4.is.re variable */) + (data->localData[0]->realVars[134] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[142] /* pwLine4.is.im variable */)) * (data->simulationInfo->realParameter[305]);
  TRACE_POP
}
/*
equation index: 310
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_310(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[138] /* pwLine4.Q12 variable */ = ((data->localData[0]->realVars[134] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[143] /* pwLine4.is.re variable */) - ((data->localData[0]->realVars[135] /* pwLine3.vr.re variable */) * (data->localData[0]->realVars[142] /* pwLine4.is.im variable */))) * (data->simulationInfo->realParameter[305]);
  TRACE_POP
}
/*
equation index: 311
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_314(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[127] /* pwLine3.P21 variable */ = (((-data->localData[0]->realVars[135] /* pwLine3.vr.re variable */)) * (data->localData[0]->realVars[131] /* pwLine3.ir.re variable */) - ((data->localData[0]->realVars[134] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[130] /* pwLine3.ir.im variable */))) * (data->simulationInfo->realParameter[294]);
  TRACE_POP
}
/*
equation index: 315
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_315(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[129] /* pwLine3.Q21 variable */ = ((data->localData[0]->realVars[135] /* pwLine3.vr.re variable */) * (data->localData[0]->realVars[130] /* pwLine3.ir.im variable */) - ((data->localData[0]->realVars[134] /* pwLine3.vr.im variable */) * (data->localData[0]->realVars[131] /* pwLine3.ir.re variable */))) * (data->simulationInfo->realParameter[294]);
  TRACE_POP
}
/*
equation index: 316
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_318(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[107] /* pwLine.Q21 variable */ = ((data->localData[0]->realVars[125] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[108] /* pwLine.ir.im variable */) - ((data->localData[0]->realVars[124] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[109] /* pwLine.ir.re variable */))) * (data->simulationInfo->realParameter[272]);
  TRACE_POP
}
/*
equation index: 319
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_319(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* pwLine.P21 variable */ = (((-data->localData[0]->realVars[125] /* pwLine1.vs.re variable */)) * (data->localData[0]->realVars[109] /* pwLine.ir.re variable */) - ((data->localData[0]->realVars[124] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[108] /* pwLine.ir.im variable */))) * (data->simulationInfo->realParameter[272]);
  TRACE_POP
}
/*
equation index: 320
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_320(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[126] /* pwLine3.P12 variable */ = ((data->localData[0]->realVars[125] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[133] /* pwLine3.is.re variable */) + (data->localData[0]->realVars[124] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[132] /* pwLine3.is.im variable */)) * (data->simulationInfo->realParameter[294]);
  TRACE_POP
}
/*
equation index: 321
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_321(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[128] /* pwLine3.Q12 variable */ = ((data->localData[0]->realVars[124] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[133] /* pwLine3.is.re variable */) - ((data->localData[0]->realVars[125] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[132] /* pwLine3.is.im variable */))) * (data->simulationInfo->realParameter[294]);
  TRACE_POP
}
/*
equation index: 322
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_322(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[114] /* pwLine1.P12 variable */ = ((data->localData[0]->realVars[125] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[121] /* pwLine1.is.re variable */) + (data->localData[0]->realVars[124] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[120] /* pwLine1.is.im variable */)) * (data->simulationInfo->realParameter[283]);
  TRACE_POP
}
/*
equation index: 323
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_323(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[116] /* pwLine1.Q12 variable */ = ((data->localData[0]->realVars[124] /* pwLine1.vs.im variable */) * (data->localData[0]->realVars[121] /* pwLine1.is.re variable */) - ((data->localData[0]->realVars[125] /* pwLine1.vs.re variable */) * (data->localData[0]->realVars[120] /* pwLine1.is.im variable */))) * (data->simulationInfo->realParameter[283]);
  TRACE_POP
}
/*
equation index: 324
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_324(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[137] /* pwLine4.P21 variable */ = (((-data->localData[0]->realVars[123] /* pwLine1.vr.re variable */)) * (data->localData[0]->realVars[141] /* pwLine4.ir.re variable */) - ((data->localData[0]->realVars[122] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[140] /* pwLine4.ir.im variable */))) * (data->simulationInfo->realParameter[305]);
  TRACE_POP
}
/*
equation index: 325
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_325(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[139] /* pwLine4.Q21 variable */ = ((data->localData[0]->realVars[123] /* pwLine1.vr.re variable */) * (data->localData[0]->realVars[140] /* pwLine4.ir.im variable */) - ((data->localData[0]->realVars[122] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[141] /* pwLine4.ir.re variable */))) * (data->simulationInfo->realParameter[305]);
  TRACE_POP
}
/*
equation index: 326
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_330(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[115] /* pwLine1.P21 variable */ = (((-data->localData[0]->realVars[123] /* pwLine1.vr.re variable */)) * (data->localData[0]->realVars[119] /* pwLine1.ir.re variable */) - ((data->localData[0]->realVars[122] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[118] /* pwLine1.ir.im variable */))) * (data->simulationInfo->realParameter[283]);
  TRACE_POP
}
/*
equation index: 331
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_331(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[117] /* pwLine1.Q21 variable */ = ((data->localData[0]->realVars[123] /* pwLine1.vr.re variable */) * (data->localData[0]->realVars[118] /* pwLine1.ir.im variable */) - ((data->localData[0]->realVars[122] /* pwLine1.vr.im variable */) * (data->localData[0]->realVars[119] /* pwLine1.ir.re variable */))) * (data->simulationInfo->realParameter[283]);
  TRACE_POP
}
/*
equation index: 332
...
when {$whenCondition2} then
  reinit(eSDC1A._simpleLagLim._state,  eSDC1A.simpleLagLim.outMax);
end when;
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_334(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[154];
  ...
  {
    data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[155];
    infoStreamPrint(LOG_EVENTS, 0, "reinit eSDC1A.simpleLagLim.state = %g", data->localData[0]->realVars[4] /* eSDC1A.simpleLagLim.state STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
int OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_functionDAE(DATA *data, threadData_t *threadData)
{
  ...
  OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_274(data, threadData);

  OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_275(data, threadData);
...
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_274(DATA* data, threadData_t *threadData);
extern void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_275(DATA* data, threadData_t *threadData);
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{902eef4d-53c6-47e1-96df-ea586524c138}";
  ...
  data->modelData->modelDataXml.nEquations = 584;
