...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_233(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */ = DIVISION((data->localData[0]->realVars[126] /* pwLine1.vs.re variable */) * (jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac10 SEED_VAR */) + (data->localData[0]->realVars[125] /* pwLine1.vs.im variable */) * (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac10 SEED_VAR */),sqrt((tmp0 * tmp0) + (tmp1 * tmp1)),"sqrt(pwLine1.vs.re ^ 2.0 + pwLine1.vs.im ^ 2.0)");
  TRACE_POP
}
...
equation index: 235
type: SIMPLE_ASSIGN
constantLoad.kI.$pDERNLSJac10.dummyVarNLSJac10 = if constantLoad.v < 0.5 then constantLoad.a2 * constantLoad.b2 * (constantLoad.v ^ (-1.0 + constantLoad.b2) * (-exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) * constantLoad.a2 * (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (constantLoad.b2 - 1.0) * constantLoad.b2 * constantLoad.v.$pDERNLSJac10.dummyVarNLSJac10) + (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (-1.0 + constantLoad.b2 - 1.0) * (-1.0 + constantLoad.b2) * constantLoad.v.$pDERNLSJac10.dummyVarNLSJac10) * exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) else 0.0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_235(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp45)
  {
    ...
    else
    {
      ...
      tmp27 = (tmp21) * ((data->simulationInfo->realParameter[66] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */));
    }
    ...
    else
    {
      ...
      tmp37 = (tmp31) * ((-1.0 + data->simulationInfo->realParameter[66] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */));
    }
  ...
  jacobian->tmpVars[2] /* constantLoad.kI.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */ = tmp46;
  TRACE_POP
}
...
equation index: 258
type: SIMPLE_ASSIGN
$res3.$pDERNLSJac10.dummyVarNLSJac10 = pwLine1.vs.im * constantLoad.p.ir.SeedNLSJac10 + pwLine1.vs.im.SeedNLSJac10 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac10) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac10.dummyVarNLSJac10 - pwLine1.vs.re * constantLoad.p.ii.SeedNLSJac10
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_258(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[2] /* $res3.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_VAR */ = (data->localData[0]->realVars[125] /* pwLine1.vs.im variable */) * (jacobian->seedVars[9] /* constantLoad.p.ir.SeedNLSJac10 SEED_VAR */) + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac10 SEED_VAR */) * (data->localData[0]->realVars[54] /* constantLoad.p.ir variable */) + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac10 SEED_VAR */)) * (data->localData[0]->realVars[53] /* constantLoad.p.ii variable */) - jacobian->tmpVars[3] /* constantLoad.Q.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */ - ((data->localData[0]->realVars[126] /* pwLine1.vs.re variable */) * (jacobian->seedVars[8] /* constantLoad.p.ii.SeedNLSJac10 SEED_VAR */));
  TRACE_POP
}
...
equation index: 259
type: SIMPLE_ASSIGN
$res4.$pDERNLSJac10.dummyVarNLSJac10 = pwLine1.vs.im * constantLoad.p.ii.SeedNLSJac10 + pwLine1.vs.im.SeedNLSJac10 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.SeedNLSJac10 + pwLine1.vs.re.SeedNLSJac10 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac10.dummyVarNLSJac10
*/
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_259(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_VAR */ = (data->localData[0]->realVars[125] /* pwLine1.vs.im variable */) * (jacobian->seedVars[8] /* constantLoad.p.ii.SeedNLSJac10 SEED_VAR */) + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac10 SEED_VAR */) * (data->localData[0]->realVars[53] /* constantLoad.p.ii variable */) + (data->localData[0]->realVars[126] /* pwLine1.vs.re variable */) * (jacobian->seedVars[9] /* constantLoad.p.ir.SeedNLSJac10 SEED_VAR */) + (jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac10 SEED_VAR */) * (data->localData[0]->realVars[54] /* constantLoad.p.ir variable */) - jacobian->tmpVars[4] /* constantLoad.P.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_264(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp75)
  {
    tmp76 = jacobian->tmpVars[21] /* pwFault.p.ir.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    RELATIONHYSTERESIS(tmp64, data->localData[0]->timeValue, data->simulationInfo->realParameter[285] /* pwFault.t2 PARAM */, 9, Less);
    tmp73 = (modelica_boolean)(tmp64 && data->simulationInfo->booleanParameter[68] /* pwFault.ground PARAM */);
    if(tmp73)
    {
      tmp74 = jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac10 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp71)
      {
        ...
        tmp72 = jacobian->tmpVars[21] /* pwFault.p.ir.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[282] /* pwFault.R PARAM */) * (jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac10 SEED_VAR */) + (data->simulationInfo->realParameter[283] /* pwFault.X PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac10 SEED_VAR */)) * ((tmp66 * tmp66) + (tmp67 * tmp67)),(tmp70 * tmp70),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp72 = jacobian->tmpVars[21] /* pwFault.p.ir.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */;
      }
      tmp74 = tmp72;
    }
    tmp76 = tmp74;
  }
  jacobian->resultVars[8] /* $res9.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_VAR */ = tmp76;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_269(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp97)
  {
    tmp98 = jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    RELATIONHYSTERESIS(tmp86, data->localData[0]->timeValue, data->simulationInfo->realParameter[285] /* pwFault.t2 PARAM */, 9, Less);
    tmp95 = (modelica_boolean)(tmp86 && data->simulationInfo->booleanParameter[68] /* pwFault.ground PARAM */);
    if(tmp95)
    {
      tmp96 = jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac10 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp93)
      {
        ...
        tmp94 = jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[282] /* pwFault.R PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac10 SEED_VAR */) - ((data->simulationInfo->realParameter[283] /* pwFault.X PARAM */) * (jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac10 SEED_VAR */))) * ((tmp88 * tmp88) + (tmp89 * tmp89)),(tmp92 * tmp92),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp94 = jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_DIFF_VAR */;
      }
      tmp96 = tmp94;
    }
    tmp98 = tmp96;
  }
  jacobian->resultVars[13] /* $res14.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_VAR */ = tmp98;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_ESDC1A_eqFunction_270(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[14] /* $res15.$pDERNLSJac10.dummyVarNLSJac10 JACOBIAN_VAR */ = ((tmp99 && tmp100)?jacobian->seedVars[0] /* pwLine3.ir.im.SeedNLSJac10 SEED_VAR */:jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac10 SEED_VAR */ - jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac10 SEED_VAR */ - ((data->simulationInfo->realParameter[316] /* pwLine3.Z.re PARAM */) * (jacobian->seedVars[0] /* pwLine3.ir.im.SeedNLSJac10 SEED_VAR */ + ((-jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac10 SEED_VAR */)) * (data->simulationInfo->realParameter[313] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac10 SEED_VAR */) * (data->simulationInfo->realParameter[314] /* pwLine3.Y.re PARAM */))) + (data->simulationInfo->realParameter[315] /* pwLine3.Z.im PARAM */) * (jacobian->seedVars[3] /* pwLine3.ir.re.SeedNLSJac10 SEED_VAR */ + (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac10 SEED_VAR */) * (data->simulationInfo->realParameter[313] /* pwLine3.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac10 SEED_VAR */) * (data->simulationInfo->realParameter[314] /* pwLine3.Y.re PARAM */)))));
  TRACE_POP
}
...
equation index: 276
type: SIMPLE_ASSIGN
$res21.$pDERNLSJac10.dummyVarNLSJac10 = $cse1 * gENCLS.vq.$pDERNLSJac10.dummyVarNLSJac10 + (-$cse2) * gENCLS.vd.$pDERNLSJac10.dummyVarNLSJac10 - pwLine1.vr.im.SeedNLSJac10
*/
...
equation index: 277
type: SIMPLE_ASSIGN
$res22.$pDERNLSJac10.dummyVarNLSJac10 = $cse2 * gENCLS.vq.$pDERNLSJac10.dummyVarNLSJac10 + $cse1 * gENCLS.vd.$pDERNLSJac10.dummyVarNLSJac10 - pwLine1.vr.re.SeedNLSJac10
*/
