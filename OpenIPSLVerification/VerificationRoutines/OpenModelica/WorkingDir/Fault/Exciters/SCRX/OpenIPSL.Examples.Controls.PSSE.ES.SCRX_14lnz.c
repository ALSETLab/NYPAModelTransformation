...
const char *OpenIPSL_Examples_Controls_PSSE_ES_SCRX_linear_model_frame()
{
  ...
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\nend linear_OpenIPSL_Examples_Controls_PSSE_ES_SCRX;\n";
}
const char *OpenIPSL_Examples_Controls_PSSE_ES_SCRX_linear_model_datarecovery_frame()
{
  return "model linear_OpenIPSL_Examples_Controls_PSSE_ES_SCRX\n  parameter Integer n = 10 \"number of states\";\n  parameter Integer p = 0 \"number of inputs\";\n  parameter Integer q = 0 \"number of outputs\";\n  parameter Integer nz = 113 \"data recovery variables\";\n"
  "\n"
  "  parameter Real x0[10] = %s;\n"
  "  parameter Real u0[0] = %s;\n"
  "  parameter Real z0[113] = %s;\n"
  "\n"
  "  parameter Real A[n, n] = [%s];\n"
  "  parameter Real B[n, p] = zeros(n, p);%s\n"
  "  parameter Real C[q, n] = zeros(q, n);%s\n"
