...
equation index: 145
type: SIMPLE_ASSIGN
sCRX._EFD0 = gENROE.efd0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_145(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,145};
  data->localData[0]->realVars[125] /* sCRX.EFD0 variable */ = data->simulationInfo->realParameter[171];
  TRACE_POP
}
/*
equation index: 146
...
equation index: 153
type: SIMPLE_ASSIGN
sCRX._imLeadLag._TF._x[1] = sCRX.imLeadLag.TF.x_scaled[1] / sCRX.imLeadLag.TF.a_end
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_153(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,153};
  data->localData[0]->realVars[127] /* sCRX.imLeadLag.TF.x[1] variable */ = DIVISION_SIM(data->localData[0]->realVars[8] /* sCRX.imLeadLag.TF.x_scaled[1] STATE(1) */,data->simulationInfo->realParameter[258],"sCRX.imLeadLag.TF.a_end",equationIndexes);
  TRACE_POP
}
/*
equation index: 154
...
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_158(DATA*, threadData_t*);
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_159(DATA*, threadData_t*);
...
vars: {pwLine._ir._im, pwLine1._is._im, constantLoad._p._ir, pwLine._ir._re, pwLine3._ir._im, pwLine4._is._im, pwLine4._is._re, pwLine3._ir._re, pwLine3._is._re, pwLine3._is._im, pwLine1._ir._re, pwLine4._ir._im, gENCLS._iq, gENCLS._id, pwLine1._vr._re, pwLine1._vr._im, gENROE._iq, gENROE._id, pwLine1._vs._im, pwLine1._vs._re, pwLine3._vr._im, pwLine3._vr._re}
eqns: {158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 180, 202, 201, 200, 199, 198, 197, 196, 195, 194, 193, 192, 191, 190, 189, 188, 187, 186, 185, 184, 183, 182, 181}
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_248(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_249(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
equation index: 269
type: SIMPLE_ASSIGN
sCRX._ECOMP = sqrt(pwLine.vs.re ^ 2.0 + pwLine.vs.im ^ 2.0)
*/
...
equation index: 272
type: SIMPLE_ASSIGN
der(sCRX._imLeadLag._TF._x_scaled[1]) = (sCRX.imLeadLag.TF.a_end * sCRX.V_erro.y - sCRX.imLeadLag.TF.a[2] * sCRX.imLeadLag.TF.x_scaled[1]) / sCRX.imLeadLag.TF.a[1]
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_272(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,272};
  data->localData[0]->realVars[18] /* der(sCRX.imLeadLag.TF.x_scaled[1]) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[258]) * (data->localData[0]->realVars[126] /* sCRX.V_erro.y variable */) - ((data->simulationInfo->realParameter[257]) * (data->localData[0]->realVars[8] /* sCRX.imLeadLag.TF.x_scaled[1] STATE(1) */)),data->simulationInfo->realParameter[256],"sCRX.imLeadLag.TF.a[1]",equationIndexes);
  TRACE_POP
}
/*
equation index: 273
type: SIMPLE_ASSIGN
sCRX._imLeadLag._TF._y = (sCRX.imLeadLag.TF.bb[2] - sCRX.imLeadLag.TF.a[2] * sCRX.imLeadLag.TF.d) * sCRX.imLeadLag.TF.x[1] + sCRX.imLeadLag.TF.d * sCRX.V_erro.y
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_273(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,273};
  data->localData[0]->realVars[128] /* sCRX.imLeadLag.TF.y variable */ = (data->simulationInfo->realParameter[262] - ((data->simulationInfo->realParameter[257]) * (data->simulationInfo->realParameter[263]))) * (data->localData[0]->realVars[127] /* sCRX.imLeadLag.TF.x[1] variable */) + (data->simulationInfo->realParameter[263]) * (data->localData[0]->realVars[126] /* sCRX.V_erro.y variable */);
  TRACE_POP
}
/*
equation index: 274
...
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_274(DATA *data, threadData_t *threadData)
{
  ...
  tmp7 = Less(fabs(data->simulationInfo->realParameter[253] - data->simulationInfo->realParameter[254]),1e-15);
  data->localData[0]->realVars[129] /* sCRX.imLeadLag.y variable */ = (tmp7?(data->simulationInfo->realParameter[252]) * (data->localData[0]->realVars[126] /* sCRX.V_erro.y variable */):data->localData[0]->realVars[128] /* sCRX.imLeadLag.TF.y variable */);
  TRACE_POP
}
/*
equation index: 275
type: SIMPLE_ASSIGN
der(sCRX._simpleLagLim._state) = (sCRX.simpleLagLim.K * sCRX.imLeadLag.y - sCRX.simpleLagLim.state) / sCRX.simpleLagLim.T_mod
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_275(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,275};
  data->localData[0]->realVars[19] /* der(sCRX.simpleLagLim.state) STATE_DER */ = DIVISION_SIM((data->simulationInfo->realParameter[271]) * (data->localData[0]->realVars[129] /* sCRX.imLeadLag.y variable */) - data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */,data->simulationInfo->realParameter[273],"sCRX.simpleLagLim.T_mod",equationIndexes);
  TRACE_POP
}
/*
equation index: 276
...
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_276(DATA *data, threadData_t *threadData)
{
  ...
  tmp8 = LessEq(fabs(data->simulationInfo->realParameter[272]),1e-15);
...
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_277(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[274], 14, Greater);
  RELATIONHYSTERESIS(tmp10, (data->simulationInfo->realParameter[271]) * (data->localData[0]->realVars[129] /* sCRX.imLeadLag.y variable */) - data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */, 0.0, 15, Less);
...
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_278(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp11, data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */, data->simulationInfo->realParameter[275], 16, Less);
  RELATIONHYSTERESIS(tmp12, (data->simulationInfo->realParameter[271]) * (data->localData[0]->realVars[129] /* sCRX.imLeadLag.y variable */) - data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */, 0.0, 17, Greater);
...
equation index: 280
type: SIMPLE_ASSIGN
gENROE._EFD = if gENROE.XADIFD < 0.0 then sCRX.negCurLogic.Crowbar_V else sCRX.negCurLogic.Vd
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_280(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp13, data->localData[0]->realVars[72] /* gENROE.XADIFD variable */, 0.0, 18, Less);
  data->localData[0]->realVars[61] /* gENROE.EFD variable */ = (tmp13?data->localData[0]->realVars[130] /* sCRX.negCurLogic.Crowbar_V variable */:data->localData[0]->realVars[131] /* sCRX.negCurLogic.Vd variable */);
  TRACE_POP
}
/*
equation index: 281
...
when {$whenCondition2} then
  reinit(sCRX._simpleLagLim._state,  sCRX.simpleLagLim.outMax);
end when;
*/
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_eqFunction_306(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[274];
  ...
  {
    data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */ = data->simulationInfo->realParameter[275];
    infoStreamPrint(LOG_EVENTS, 0, "reinit sCRX.simpleLagLim.state = %g", data->localData[0]->realVars[9] /* sCRX.simpleLagLim.state STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void OpenIPSL_Examples_Controls_PSSE_ES_SCRX_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{a02aa362-1fef-47e5-82ae-3d88f05a1548}";
  ...
  data->modelData->nParametersReal = 277;
  ...
  data->modelData->modelDataXml.nEquations = 537;
