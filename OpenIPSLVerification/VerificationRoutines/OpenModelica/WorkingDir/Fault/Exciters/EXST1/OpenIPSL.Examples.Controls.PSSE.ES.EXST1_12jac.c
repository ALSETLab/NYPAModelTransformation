...
equation index: 739
type: SIMPLE_ASSIGN
constantLoad.kI.$pDERNLSJac29.dummyVarNLSJac29 = if constantLoad.v < 0.5 then constantLoad.a2 * constantLoad.b2 * (constantLoad.v ^ (-1.0 + constantLoad.b2) * (-exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) * constantLoad.a2 * (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (constantLoad.b2 - 1.0) * constantLoad.b2 * constantLoad.v.$pDERNLSJac29.dummyVarNLSJac29) + (if noEvent(constantLoad.v == 0.0) then 0.0 else constantLoad.v ^ (-1.0 + constantLoad.b2 - 1.0) * (-1.0 + constantLoad.b2) * constantLoad.v.$pDERNLSJac29.dummyVarNLSJac29) * exp((-constantLoad.a2) * constantLoad.v ^ constantLoad.b2)) else 0.0
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_739(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp44)
  {
    ...
    else
    {
      ...
      tmp26 = (tmp20) * ((data->simulationInfo->realParameter[64] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */));
    }
    ...
    else
    {
      ...
      tmp36 = (tmp30) * ((-1.0 + data->simulationInfo->realParameter[64] /* constantLoad.b2 PARAM */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */));
    }
  ...
  jacobian->tmpVars[1] /* constantLoad.kI.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */ = tmp45;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_762(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp65)
  {
    tmp66 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp63)
    {
      tmp64 = jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac29 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp61)
      {
        ...
        tmp62 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[255] /* pwFault.R PARAM */) * (jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac29 SEED_VAR */) + (data->simulationInfo->realParameter[256] /* pwFault.X PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac29 SEED_VAR */)) * ((tmp56 * tmp56) + (tmp57 * tmp57)),(tmp60 * tmp60),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp62 = jacobian->tmpVars[20] /* pwFault.p.ir.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */;
      }
      tmp64 = tmp62;
    }
    tmp66 = tmp64;
  }
  jacobian->resultVars[1] /* $res2.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_VAR */ = tmp66;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_763(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp79)
  {
    tmp80 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp77)
    {
      tmp78 = jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac29 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp75)
      {
        ...
        tmp76 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[255] /* pwFault.R PARAM */) * (jacobian->seedVars[20] /* pwLine3.vr.im.SeedNLSJac29 SEED_VAR */) - ((data->simulationInfo->realParameter[256] /* pwFault.X PARAM */) * (jacobian->seedVars[21] /* pwLine3.vr.re.SeedNLSJac29 SEED_VAR */))) * ((tmp70 * tmp70) + (tmp71 * tmp71)),(tmp74 * tmp74),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp76 = jacobian->tmpVars[19] /* pwFault.p.ii.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */;
      }
      tmp78 = tmp76;
    }
    tmp80 = tmp78;
  }
  jacobian->resultVars[2] /* $res3.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_VAR */ = tmp80;
  TRACE_POP
}
...
equation index: 773
type: SIMPLE_ASSIGN
$res13.$pDERNLSJac29.dummyVarNLSJac29 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.re.$pDERNLSJac29.dummyVarNLSJac29 else pwLine.vs.re.$pDERNLSJac29.dummyVarNLSJac29 - pwLine1.vs.re.SeedNLSJac29 - (pwLine.Z.re * (pwLine.is.re.$pDERNLSJac29.dummyVarNLSJac29 + pwLine.vs.im.$pDERNLSJac29.dummyVarNLSJac29 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac29.dummyVarNLSJac29 * pwLine.Y.re) - pwLine.Z.im * (pwLine.is.im.$pDERNLSJac29.dummyVarNLSJac29 + (-pwLine.vs.re.$pDERNLSJac29.dummyVarNLSJac29) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac29.dummyVarNLSJac29 * pwLine.Y.re))
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_776(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[15] /* $res16.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_VAR */ = ((tmp105 && tmp106)?jacobian->tmpVars[22] /* pwLine.ir.re.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */:jacobian->seedVars[19] /* pwLine1.vs.re.SeedNLSJac29 SEED_VAR */ - jacobian->tmpVars[12] /* pwLine.vs.re.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[267] /* pwLine.Z.re PARAM */) * (jacobian->tmpVars[22] /* pwLine.ir.re.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac29 SEED_VAR */) * (data->simulationInfo->realParameter[264] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[19] /* pwLine1.vs.re.SeedNLSJac29 SEED_VAR */) * (data->simulationInfo->realParameter[265] /* pwLine.Y.re PARAM */))) - ((data->simulationInfo->realParameter[266] /* pwLine.Z.im PARAM */) * (jacobian->seedVars[4] /* pwLine.ir.im.SeedNLSJac29 SEED_VAR */ + ((-jacobian->seedVars[19] /* pwLine1.vs.re.SeedNLSJac29 SEED_VAR */)) * (data->simulationInfo->realParameter[264] /* pwLine.Y.im PARAM */) - ((jacobian->seedVars[18] /* pwLine1.vs.im.SeedNLSJac29 SEED_VAR */) * (data->simulationInfo->realParameter[265] /* pwLine.Y.re PARAM */))))));
  TRACE_POP
}
...
equation index: 777
type: SIMPLE_ASSIGN
$res17.$pDERNLSJac29.dummyVarNLSJac29 = pwLine1.vs.im * constantLoad.p.ir.SeedNLSJac29 + pwLine1.vs.im.SeedNLSJac29 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac29) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac29.dummyVarNLSJac29 - pwLine1.vs.re * constantLoad.p.ii.$pDERNLSJac29.dummyVarNLSJac29
*/
...
equation index: 778
type: SIMPLE_ASSIGN
$res18.$pDERNLSJac29.dummyVarNLSJac29 = pwLine1.vs.im * constantLoad.p.ii.$pDERNLSJac29.dummyVarNLSJac29 + pwLine1.vs.im.SeedNLSJac29 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.SeedNLSJac29 + pwLine1.vs.re.SeedNLSJac29 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac29.dummyVarNLSJac29
*/
...
equation index: 780
type: SIMPLE_ASSIGN
$res20.$pDERNLSJac29.dummyVarNLSJac29 = $cse1 * gENCLS.vq.$pDERNLSJac29.dummyVarNLSJac29 + (-$cse2) * gENCLS.vd.$pDERNLSJac29.dummyVarNLSJac29 - pwLine1.vr.im.SeedNLSJac29
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_780(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[19] /* $res20.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_VAR */ = (data->localData[0]->realVars[24] /* $cse1 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */) + ((-data->localData[0]->realVars[25] /* $cse2 variable */)) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[15] /* pwLine1.vr.im.SeedNLSJac29 SEED_VAR */;
  TRACE_POP
}
...
equation index: 782
type: SIMPLE_ASSIGN
$res22.$pDERNLSJac29.dummyVarNLSJac29 = $cse2 * gENCLS.vq.$pDERNLSJac29.dummyVarNLSJac29 + $cse1 * gENCLS.vd.$pDERNLSJac29.dummyVarNLSJac29 - pwLine1.vr.re.SeedNLSJac29
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_782(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH
  const int clockIndex = 0;
  const int equationIndexes[2] = {1,782};
  jacobian->resultVars[21] /* $res22.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_VAR */ = (data->localData[0]->realVars[25] /* $cse2 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */) + (data->localData[0]->realVars[24] /* $cse1 variable */) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac29.dummyVarNLSJac29 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[14] /* pwLine1.vr.re.SeedNLSJac29 SEED_VAR */;
  TRACE_POP
}
...
int OpenIPSL_Examples_Controls_PSSE_ES_EXST1_functionJacNLSJac29_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_782(data, threadData, jacobian, parentJacobian);
  TRACE_POP
  return 0;
}
/* constant equations */
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_816(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    tmp114 = (tmp112?0.0:jacobian->seedVars[0] /* eXST1.feedback.y.SeedNLSJac30 SEED_VAR */);
  }
  jacobian->tmpVars[0] /* eXST1.imLeadLag.u.$pDERNLSJac30.dummyVarNLSJac30 JACOBIAN_DIFF_VAR */ = tmp114;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_820(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* eXST1.Vm1.y.$pDERNLSJac30.dummyVarNLSJac30 JACOBIAN_DIFF_VAR */ = (tmp116?(jacobian->tmpVars[3] /* eXST1.K_a.y.$pDERNLSJac30.dummyVarNLSJac30 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[109] /* eXST1.Vm1.K PARAM */):0.0);
  TRACE_POP
}
...
equation index: 822
type: SIMPLE_ASSIGN
$res1.$pDERNLSJac30.dummyVarNLSJac30 = (-eXST1.imDerivativeLag.y.$pDERNLSJac30.dummyVarNLSJac30) - eXST1.feedback.y.SeedNLSJac30
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_822(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH
  const int clockIndex = 0;
  const int equationIndexes[2] = {1,822};
  jacobian->resultVars[0] /* $res1.$pDERNLSJac30.dummyVarNLSJac30 JACOBIAN_VAR */ = (-jacobian->tmpVars[5] /* eXST1.imDerivativeLag.y.$pDERNLSJac30.dummyVarNLSJac30 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[0] /* eXST1.feedback.y.SeedNLSJac30 SEED_VAR */;
  TRACE_POP
}
...
int OpenIPSL_Examples_Controls_PSSE_ES_EXST1_functionJacNLSJac30_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  OpenIPSL_Examples_Controls_PSSE_ES_EXST1_eqFunction_822(data, threadData, jacobian, parentJacobian);
  TRACE_POP
  return 0;
}
