...
#Working Directory
LVExcitersWorkingDir = "/home/manuelnvro/dev/Gitted/NYPAModelTransformation/OpenIPSLVerification/VerificationRoutines/OpenModelica/WorkingDir/LoadVariation/Exciters/"
...
for exciterNumber, exciterName in enumerate(exciters['names']):
    ...
    try:
        ...
        sim = SimRes(""+LVExcitersWorkingDir+f"{exciterName}/OpenIPSL.Examples.Controls.PSSE.ES.{exciterName}_res.mat")
